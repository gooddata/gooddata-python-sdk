...
def test_get_llm_endpoint(test_config):
    ...
    try:
        ...
        assert retrieved_endpoint.attributes.token is None  # Token not returned for security
...
def test_create_llm_endpoint(test_config):
    ...
    try:
        ...
        assert llm_endpoint_1.attributes.token is None
        ...
        # Token is not returned in the API response for security reasons
        assert llm_endpoint_2.attributes.token is None
...
def test_update_llm_endpoint(test_config):
    ...
    try:
        ...
        # Token is not returned in the API response for security reasons
        assert llm_endpoint_3.attributes.token is None
