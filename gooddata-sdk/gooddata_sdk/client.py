...
class GoodDataApiClient:
    def __init__(self, host, token, extra_user_agent=None):
        ...
        self._metadata_client = metadata_client.ApiClient(configuration=self._metadata_config,
        ...
        self._afm_client = afm_client.ApiClient(configuration=self._afm_config, header_name='Authorization',
