...
class JsonApiComputedAttributeOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiComputedAttributeOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiComputedAttributeOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiComputedAttributeOutWithLinks]):
