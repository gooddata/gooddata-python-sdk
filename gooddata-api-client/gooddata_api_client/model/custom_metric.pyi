...
class CustomMetric(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["format", "title", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["format", "title", ], str]):
