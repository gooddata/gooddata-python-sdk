...
def lazy_import():
    ...
    globals()['JsonApiFiscalCalendarOutWithLinks'] = JsonApiFiscalCalendarOutWithLinks
    globals()['ListLinks'] = ListLinks


class JsonApiFiscalCalendarOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiFiscalCalendarOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiFiscalCalendarOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiFiscalCalendarOutWithLinks]):
