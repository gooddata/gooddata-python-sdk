...
class AlertAfm(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, filters, measures, *args, **kwargs):  # noqa: E501
        """AlertAfm - a model defined in OpenAPI
