...
def lazy_import():
    ...
    globals()['JsonApiCustomApplicationSettingPostOptionalId'] = JsonApiCustomApplicationSettingPostOptionalId


class JsonApiCustomApplicationSettingPostOptionalIdDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiCustomApplicationSettingPostOptionalId,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiCustomApplicationSettingPostOptionalIdDocument - a model defined in OpenAPI
