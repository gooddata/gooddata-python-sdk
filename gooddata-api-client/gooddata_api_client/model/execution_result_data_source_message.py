...
class ExecutionResultDataSourceMessage(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, correlation_id, source, type, *args, **kwargs):  # noqa: E501
        """ExecutionResultDataSourceMessage - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Data of this particular supplementary info item: a free-form JSON specific to the particular supplementary info item type.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, correlation_id, source, type, *args, **kwargs):  # noqa: E501
        """ExecutionResultDataSourceMessage - a model defined in OpenAPI
