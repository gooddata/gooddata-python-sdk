    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class attributes(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["cachePath", "decodedParameters", "enableCaching", "name", "parameters", "schema", "type", "url", "username", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cachePath", "decodedParameters", "enableCaching", "name", "parameters", "schema", "type", "url", "username", ], str]):
                    return super().get_item_oapg(name)
