...
def lazy_import():
    ...
    globals()['JsonApiUserIdentifierOut'] = JsonApiUserIdentifierOut
...
class JsonApiUserIdentifierOutWithLinks(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JsonApiUserIdentifierOutWithLinks - a model defined in OpenAPI

        Keyword Args:
            id (str): API identifier of an object
            type (str): Object type. defaults to "userIdentifier", must be one of ["userIdentifier", ]  # noqa: E501
        ...
        type = kwargs.get('type', "userIdentifier")
