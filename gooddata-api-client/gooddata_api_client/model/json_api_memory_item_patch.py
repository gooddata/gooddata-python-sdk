...
def lazy_import():
    ...
    globals()['JsonApiMemoryItemPatchAttributes'] = JsonApiMemoryItemPatchAttributes


class JsonApiMemoryItemPatch(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'attributes': (JsonApiMemoryItemPatchAttributes,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, attributes, id, *args, **kwargs):  # noqa: E501
        """JsonApiMemoryItemPatch - a model defined in OpenAPI
