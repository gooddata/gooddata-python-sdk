...
def lazy_import():
    ...
    globals()['JsonApiFilterViewIn'] = JsonApiFilterViewIn


class JsonApiFilterViewInDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiFilterViewIn,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiFilterViewInDocument - a model defined in OpenAPI
