...
def lazy_import():
    ...
    globals()['JsonApiParameterPostOptionalId'] = JsonApiParameterPostOptionalId


class JsonApiParameterPostOptionalIdDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiParameterPostOptionalId,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiParameterPostOptionalIdDocument - a model defined in OpenAPI
