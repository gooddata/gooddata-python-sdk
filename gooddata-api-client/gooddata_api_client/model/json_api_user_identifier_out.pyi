...
class JsonApiUserIdentifierOut(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                def USER_IDENTIFIER(cls):
                    return cls("userIdentifier")
            ...
            class attributes(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "firstname", "lastname", ], str]):
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "firstname", "lastname", ], str]):
