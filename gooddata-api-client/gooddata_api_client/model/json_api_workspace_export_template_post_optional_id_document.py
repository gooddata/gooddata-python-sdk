...
def lazy_import():
    ...
    globals()['JsonApiWorkspaceExportTemplatePostOptionalId'] = JsonApiWorkspaceExportTemplatePostOptionalId


class JsonApiWorkspaceExportTemplatePostOptionalIdDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiWorkspaceExportTemplatePostOptionalId,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiWorkspaceExportTemplatePostOptionalIdDocument - a model defined in OpenAPI
