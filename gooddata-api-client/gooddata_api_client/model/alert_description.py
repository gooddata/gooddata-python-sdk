...
def lazy_import():
    ...
    globals()['AlertEvaluationRow'] = AlertEvaluationRow


class AlertDescription(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, condition, metric, *args, **kwargs):  # noqa: E501
        """AlertDescription - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, condition, metric, *args, **kwargs):  # noqa: E501
        """AlertDescription - a model defined in OpenAPI
