...
class PrimaryKeyConfig(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PrimaryKeyConfig - a model defined in OpenAPI

        Args:

        Keyword Args:
            type (str): defaults to "primary", must be one of ["primary", ]  # noqa: E501
