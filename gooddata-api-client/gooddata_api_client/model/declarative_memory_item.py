...
class DeclarativeMemoryItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, instruction, strategy, title, *args, **kwargs):  # noqa: E501
        """DeclarativeMemoryItem - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str): Memory item description.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, instruction, strategy, title, *args, **kwargs):  # noqa: E501
        """DeclarativeMemoryItem - a model defined in OpenAPI
