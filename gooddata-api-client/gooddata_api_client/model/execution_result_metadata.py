...
class ExecutionResultMetadata(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data_source_messages, *args, **kwargs):  # noqa: E501
        """ExecutionResultMetadata - a model defined in OpenAPI

        Args:
            data_source_messages ([ExecutionResultDataSourceMessage]): Additional information sent by the underlying data source.
        ...
        self.data_source_messages = data_source_messages
    ...
    @convert_js_args_to_python_args
    def __init__(self, data_source_messages, *args, **kwargs):  # noqa: E501
        """ExecutionResultMetadata - a model defined in OpenAPI
