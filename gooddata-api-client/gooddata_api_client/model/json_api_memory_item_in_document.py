...
def lazy_import():
    ...
    globals()['JsonApiMemoryItemIn'] = JsonApiMemoryItemIn


class JsonApiMemoryItemInDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiMemoryItemIn,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiMemoryItemInDocument - a model defined in OpenAPI
