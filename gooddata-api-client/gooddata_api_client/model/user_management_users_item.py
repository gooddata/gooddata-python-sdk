...
class UserManagementUsersItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, groups, organization_admin, user_id, workspaces, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, groups, organization_admin, user_id, workspaces, *args, **kwargs):  # noqa: E501
        """UserManagementUsersItem - a model defined in OpenAPI
