...
class ColumnStatisticWarning(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["action", "message", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["action", "message", ], str]):
