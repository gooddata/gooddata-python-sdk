...
def lazy_import():
    ...
    globals()['AttributeElements'] = AttributeElements
...
class DashboardAttributeFilterAttributeFilter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, attribute_elements, display_form, negative_selection, *args, **kwargs):  # noqa: E501
        """DashboardAttributeFilterAttributeFilter - a model defined in OpenAPI

        Args:
            attribute_elements (AttributeElements):
    ...
    @convert_js_args_to_python_args
    def __init__(self, attribute_elements, display_form, negative_selection, *args, **kwargs):  # noqa: E501
        """DashboardAttributeFilterAttributeFilter - a model defined in OpenAPI
