...
class AbsoluteGranularityDateFilterAbsoluteGranularityDateFilter(ModelNormal):
    ...
    validations = {
        ('_from',): {
            'regex': {
                'pattern': r'^((?:\d{4})|(?:\d{4}-[1-4])|(?:\d{4}-(0[1-9]|1[0-2]))|(?:\d{4}-(0[1-9]|[1-4]\d|5[0-3]))|(?:\d{4}-\d{2}-\d{2})|(?:[0-9]|[1-5]\d)|(?:[0-9]|[1-9]\d{1,3}|[1-7]\d{4}|8[0-5]\d{3}|86[0-3]\d{2})|(?:[0-9]|[1-5]\d)|(?:[0-9]|[1-9]\d{1,2}|1[0-3]\d{2}|14[0-3]\d)|(?:[0-9]|1\d|2[0-3])|(?:[0-6])|(?:[1-9]|[12]\d|3[01])|(?:[1-9]|[1-8]\d|9[0-2])|(?:[1-9]|[1-9]\d|[12]\d\d|3[0-5]\d|36[0-6])|(?:[1-9]|[1-4]\d|5[0-3])|(?:[1-9]|1[0-2])|(?:[1-4]))$',  # noqa: E501
            },
        },
        ('to',): {
            'regex': {
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dataset, granularity, *args, **kwargs):  # noqa: E501
        """AbsoluteGranularityDateFilterAbsoluteGranularityDateFilter - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            _from (str, none_type): Start of the range (including), in the format matching 'granularity'. If omitted, the range is unbounded at the start.. [optional]  # noqa: E501
            local_identifier (str): [optional]  # noqa: E501
            to (str, none_type): End of the range (including), in the format matching 'granularity'. If omitted, the range is unbounded at the end.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, dataset, granularity, *args, **kwargs):  # noqa: E501
        """AbsoluteGranularityDateFilterAbsoluteGranularityDateFilter - a model defined in OpenAPI
