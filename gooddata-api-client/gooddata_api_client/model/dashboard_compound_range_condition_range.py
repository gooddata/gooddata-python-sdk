...
class DashboardCompoundRangeConditionRange(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, _from, operator, to, *args, **kwargs):  # noqa: E501
        """DashboardCompoundRangeConditionRange - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, _from, operator, to, *args, **kwargs):  # noqa: E501
        """DashboardCompoundRangeConditionRange - a model defined in OpenAPI
