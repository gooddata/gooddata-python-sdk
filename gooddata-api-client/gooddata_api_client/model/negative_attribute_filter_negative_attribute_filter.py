...
class NegativeAttributeFilterNegativeAttributeFilter(ModelNormal):
    ...
    def _from_openapi_data(cls, label, not_in, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            uses_arbitrary_values (bool): If true, indicates that the values in notInElements were filled free-form, otherwise they have been picked from existing elements.. [optional]  # noqa: E501
        """
