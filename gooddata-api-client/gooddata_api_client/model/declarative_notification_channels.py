...
class DeclarativeNotificationChannels(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, notification_channels, *args, **kwargs):  # noqa: E501
        """DeclarativeNotificationChannels - a model defined in OpenAPI

        Args:
            notification_channels ([DeclarativeNotificationChannel]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, notification_channels, *args, **kwargs):  # noqa: E501
        """DeclarativeNotificationChannels - a model defined in OpenAPI
