...
class JsonApiUserIdentifierOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiUserIdentifierOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiUserIdentifierOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiUserIdentifierOutWithLinks]):
