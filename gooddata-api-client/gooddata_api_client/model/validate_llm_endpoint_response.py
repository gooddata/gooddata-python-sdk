...
class ValidateLLMEndpointResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, message, successful, *args, **kwargs):  # noqa: E501
        """ValidateLLMEndpointResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, message, successful, *args, **kwargs):  # noqa: E501
        """ValidateLLMEndpointResponse - a model defined in OpenAPI
