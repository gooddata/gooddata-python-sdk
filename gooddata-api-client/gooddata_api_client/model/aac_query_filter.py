...
class AacQueryFilter(ModelNormal):
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """AacQueryFilter - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            using (str): Reference to attribute/label/date/metric/fact (type-prefixed id).. [optional]  # noqa: E501
            value (float): Value for metric value filter.. [optional]  # noqa: E501
        """
