...
def lazy_import():
    ...
    globals()['JsonApiWorkspaceThemeOut'] = JsonApiWorkspaceThemeOut
    globals()['ObjectLinks'] = ObjectLinks
    globals()['ObjectLinksContainer'] = ObjectLinksContainer


class JsonApiWorkspaceThemeOutWithLinks(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JsonApiWorkspaceThemeOutWithLinks - a model defined in OpenAPI

        Keyword Args:
            attributes (JsonApiColorPaletteInAttributes):
            id (str): API identifier of an object
            type (str): Object type. defaults to "workspaceTheme", must be one of ["workspaceTheme", ]  # noqa: E501
        ...
        type = kwargs.get('type', "workspaceTheme")
