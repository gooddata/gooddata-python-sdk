...
class JsonApiExportDefinitionOutList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    def items() -> typing.Type['JsonApiExportDefinitionOutWithLinks']:
                        return JsonApiExportDefinitionOutWithLinks
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiExportDefinitionOutWithLinks'], typing.List['JsonApiExportDefinitionOutWithLinks']],
                ...
                def __getitem__(self, i: int) -> 'JsonApiExportDefinitionOutWithLinks':
            ...
            class included(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JsonApiExportDefinitionOutIncludes']:
                        return JsonApiExportDefinitionOutIncludes
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiExportDefinitionOutIncludes'], typing.List['JsonApiExportDefinitionOutIncludes']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'included':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'JsonApiExportDefinitionOutIncludes':
                    return super().__getitem__(i)
