...
class JsonApiFilterContextOutDocument(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['JsonApiFilterContextOut']:
                return JsonApiFilterContextOut
            ...
            class included(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JsonApiFilterContextOutIncludes']:
                        return JsonApiFilterContextOutIncludes
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiFilterContextOutIncludes'], typing.List['JsonApiFilterContextOutIncludes']],
                ...
                def __getitem__(self, i: int) -> 'JsonApiFilterContextOutIncludes':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'JsonApiFilterContextOut': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'JsonApiFilterContextOut': ...
