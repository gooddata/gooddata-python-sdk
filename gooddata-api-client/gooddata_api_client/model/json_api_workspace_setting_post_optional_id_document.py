...
def lazy_import():
    ...
    globals()['JsonApiWorkspaceSettingPostOptionalId'] = JsonApiWorkspaceSettingPostOptionalId


class JsonApiWorkspaceSettingPostOptionalIdDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiWorkspaceSettingPostOptionalId,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiWorkspaceSettingPostOptionalIdDocument - a model defined in OpenAPI
