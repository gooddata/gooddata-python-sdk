...
def lazy_import():
    ...
    globals()['JsonApiWorkspaceColorPaletteOut'] = JsonApiWorkspaceColorPaletteOut
    globals()['ObjectLinks'] = ObjectLinks
    globals()['ObjectLinksContainer'] = ObjectLinksContainer


class JsonApiWorkspaceColorPaletteOutWithLinks(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JsonApiWorkspaceColorPaletteOutWithLinks - a model defined in OpenAPI

        Keyword Args:
            attributes (JsonApiColorPaletteInAttributes):
            id (str): API identifier of an object
            type (str): Object type. defaults to "workspaceColorPalette", must be one of ["workspaceColorPalette", ]  # noqa: E501
        ...
        type = kwargs.get('type', "workspaceColorPalette")
