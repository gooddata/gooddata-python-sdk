...
class JsonApiWorkspaceExportTemplateOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiWorkspaceExportTemplateOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiWorkspaceExportTemplateOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiWorkspaceExportTemplateOutWithLinks]):
