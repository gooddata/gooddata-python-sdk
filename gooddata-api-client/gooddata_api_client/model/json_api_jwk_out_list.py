...
def lazy_import():
    ...
    globals()['JsonApiJwkOutWithLinks'] = JsonApiJwkOutWithLinks
    globals()['ListLinks'] = ListLinks


class JsonApiJwkOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiJwkOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiJwkOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiJwkOutWithLinks]):
