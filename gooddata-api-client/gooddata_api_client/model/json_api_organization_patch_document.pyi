...
class JsonApiOrganizationPatchDocument(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['JsonApiOrganizationPatch']:
                return JsonApiOrganizationPatch
            __annotations__ = {
                "data": data,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'JsonApiOrganizationPatch': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'JsonApiOrganizationPatch': ...
