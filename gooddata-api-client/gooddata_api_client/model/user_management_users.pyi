...
class UserManagementUsers(
        ...
        class properties:
            ...
            class users(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['UserManagementUsersItem']:
                        return UserManagementUsersItem
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['UserManagementUsersItem'], typing.List['UserManagementUsersItem']],
                ...
                def __getitem__(self, i: int) -> 'UserManagementUsersItem':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["totalCount", "users", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["totalCount", "users", ], str]):
