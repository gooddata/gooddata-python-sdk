...
class AfmValidDescendantsQuery(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'attributes': ([AfmObjectIdentifierAttribute],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, attributes, *args, **kwargs):  # noqa: E501
        """AfmValidDescendantsQuery - a model defined in OpenAPI

        Args:
            attributes ([AfmObjectIdentifierAttribute]): List of identifiers of the attributes to get the valid descendants for.
