...
class DeclarativeUserDataFilters(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_data_filters, *args, **kwargs):  # noqa: E501
        """DeclarativeUserDataFilters - a model defined in OpenAPI

        Args:
            user_data_filters ([DeclarativeUserDataFilter]):
        ...
        self.user_data_filters = user_data_filters
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_data_filters, *args, **kwargs):  # noqa: E501
        """DeclarativeUserDataFilters - a model defined in OpenAPI
