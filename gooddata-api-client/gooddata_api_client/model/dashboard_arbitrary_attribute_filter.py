...
class DashboardArbitraryAttributeFilter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, arbitrary_attribute_filter, *args, **kwargs):  # noqa: E501
        """DashboardArbitraryAttributeFilter - a model defined in OpenAPI

        Args:
            arbitrary_attribute_filter (DashboardArbitraryAttributeFilterArbitraryAttributeFilter):
        ...
        self.arbitrary_attribute_filter = arbitrary_attribute_filter
    ...
    @convert_js_args_to_python_args
    def __init__(self, arbitrary_attribute_filter, *args, **kwargs):  # noqa: E501
        """DashboardArbitraryAttributeFilter - a model defined in OpenAPI
