...
class JsonApiWorkspaceAutomationOutList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JsonApiWorkspaceAutomationOutWithLinks']:
                        return JsonApiWorkspaceAutomationOutWithLinks
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiWorkspaceAutomationOutWithLinks'], typing.List['JsonApiWorkspaceAutomationOutWithLinks']],
                ...
                def __getitem__(self, i: int) -> 'JsonApiWorkspaceAutomationOutWithLinks':
            ...
            class included(
                ...
                class MetaOapg:
                    ...
                    def items() -> typing.Type['JsonApiWorkspaceAutomationOutIncludes']:
                        return JsonApiWorkspaceAutomationOutIncludes
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiWorkspaceAutomationOutIncludes'], typing.List['JsonApiWorkspaceAutomationOutIncludes']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'included':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'JsonApiWorkspaceAutomationOutIncludes':
                    return super().__getitem__(i)
