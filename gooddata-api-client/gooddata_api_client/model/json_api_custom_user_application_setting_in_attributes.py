...
class JsonApiCustomUserApplicationSettingInAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, application_name, content, *args, **kwargs):  # noqa: E501
        """JsonApiCustomUserApplicationSettingInAttributes - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            workspace_id (str, none_type): Workspace scope for this setting. Must reference an existing workspace the caller has at least VIEW access to. Null means user-level (no workspace scope).. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, application_name, content, *args, **kwargs):  # noqa: E501
        """JsonApiCustomUserApplicationSettingInAttributes - a model defined in OpenAPI
