...
class AbsoluteGranularityDateFilter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, absolute_granularity_date_filter, *args, **kwargs):  # noqa: E501
        """AbsoluteGranularityDateFilter - a model defined in OpenAPI

        Args:
            absolute_granularity_date_filter (AbsoluteGranularityDateFilterAbsoluteGranularityDateFilter):
        ...
        self.absolute_granularity_date_filter = absolute_granularity_date_filter
    ...
    @convert_js_args_to_python_args
    def __init__(self, absolute_granularity_date_filter, *args, **kwargs):  # noqa: E501
        """AbsoluteGranularityDateFilter - a model defined in OpenAPI
