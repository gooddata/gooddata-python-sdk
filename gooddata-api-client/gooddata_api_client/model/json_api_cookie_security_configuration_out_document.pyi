...
class JsonApiCookieSecurityConfigurationOutDocument(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['JsonApiCookieSecurityConfigurationOut']:
                return JsonApiCookieSecurityConfigurationOut
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'JsonApiCookieSecurityConfigurationOut': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'JsonApiCookieSecurityConfigurationOut': ...
