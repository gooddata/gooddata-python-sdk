...
def lazy_import():
    ...
    globals()['JsonApiAgentOutWithLinks'] = JsonApiAgentOutWithLinks
    globals()['ListLinks'] = ListLinks


class JsonApiAgentOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiAgentOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiAgentOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiAgentOutWithLinks]):
