...
class JsonApiVisualizationObjectToManyLinkage(
    schemas.ListSchema
):
    ...
    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['JsonApiVisualizationObjectLinkage'], typing.List['JsonApiVisualizationObjectLinkage']],
