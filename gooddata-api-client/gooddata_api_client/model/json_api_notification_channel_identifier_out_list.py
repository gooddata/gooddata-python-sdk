...
class JsonApiNotificationChannelIdentifierOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiNotificationChannelIdentifierOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiNotificationChannelIdentifierOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiNotificationChannelIdentifierOutWithLinks]):
