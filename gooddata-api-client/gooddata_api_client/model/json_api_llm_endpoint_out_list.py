...
class JsonApiLlmEndpointOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiLlmEndpointOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiLlmEndpointOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiLlmEndpointOutWithLinks]):
