...
class JsonApiCustomApplicationSettingPatchDocument(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['JsonApiCustomApplicationSettingPatch']:
                return JsonApiCustomApplicationSettingPatch
            __annotations__ = {
                "data": data,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'JsonApiCustomApplicationSettingPatch': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'JsonApiCustomApplicationSettingPatch': ...
