...
def lazy_import():
    ...
    globals()['JsonApiLlmEndpointPatchAttributes'] = JsonApiLlmEndpointPatchAttributes


class JsonApiLlmEndpointPatch(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'attributes': (JsonApiLlmEndpointPatchAttributes,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, attributes, id, *args, **kwargs):  # noqa: E501
        """JsonApiLlmEndpointPatch - a model defined in OpenAPI
