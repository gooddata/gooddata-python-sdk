...
class Skeleton(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["content", "href", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["content", "href", ], str]):
