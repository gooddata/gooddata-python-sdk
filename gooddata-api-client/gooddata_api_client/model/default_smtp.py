...
def lazy_import():
    ...
    globals()['DefaultSmtpAllOf'] = DefaultSmtpAllOf


class DefaultSmtp(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DefaultSmtp - a model defined in OpenAPI

        Keyword Args:
            type (str): The destination type.. defaults to "DEFAULT_SMTP", must be one of ["DEFAULT_SMTP", ]  # noqa: E501
        ...
        type = kwargs.get('type', "DEFAULT_SMTP")
