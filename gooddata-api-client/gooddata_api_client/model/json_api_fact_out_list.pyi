        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JsonApiFactOutWithLinks']:
                        return JsonApiFactOutWithLinks
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiFactOutWithLinks'], typing.List['JsonApiFactOutWithLinks']],
                ...
                def __getitem__(self, i: int) -> 'JsonApiFactOutWithLinks':
            ...
            class included(
                ...
                class MetaOapg:
                    ...
                    def items() -> typing.Type['JsonApiDatasetOutWithLinks']:
                        return JsonApiDatasetOutWithLinks
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiDatasetOutWithLinks'], typing.List['JsonApiDatasetOutWithLinks']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'included':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'JsonApiDatasetOutWithLinks':
                    return super().__getitem__(i)
