...
class JsonApiNotificationChannelOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiNotificationChannelOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiNotificationChannelOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiNotificationChannelOutWithLinks]):
