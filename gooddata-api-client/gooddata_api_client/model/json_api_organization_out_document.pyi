...
class JsonApiOrganizationOutDocument(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['JsonApiOrganizationOut']:
                return JsonApiOrganizationOut
            ...
            class included(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JsonApiOrganizationOutIncludes']:
                        return JsonApiOrganizationOutIncludes
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiOrganizationOutIncludes'], typing.List['JsonApiOrganizationOutIncludes']],
                ...
                def __getitem__(self, i: int) -> 'JsonApiOrganizationOutIncludes':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'JsonApiOrganizationOut': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'JsonApiOrganizationOut': ...
