...
class NotificationFilter(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["filter", "title", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["filter", "title", ], str]):
