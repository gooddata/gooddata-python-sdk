...
def lazy_import():
    ...
    globals()['JsonApiCustomUserApplicationSettingPostOptionalId'] = JsonApiCustomUserApplicationSettingPostOptionalId


class JsonApiCustomUserApplicationSettingPostOptionalIdDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiCustomUserApplicationSettingPostOptionalId,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiCustomUserApplicationSettingPostOptionalIdDocument - a model defined in OpenAPI
