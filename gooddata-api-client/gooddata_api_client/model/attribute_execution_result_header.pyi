...
class AttributeExecutionResultHeader(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def attributeHeader() -> typing.Type['AttributeResultHeader']:
                return AttributeResultHeader
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["attributeHeader"]) -> 'AttributeResultHeader': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["attributeHeader"]) -> 'AttributeResultHeader': ...
