...
class JsonApiAttributeHierarchyOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiAttributeHierarchyOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiAttributeHierarchyOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiAttributeHierarchyOutWithLinks]):
