...
def lazy_import():
    ...
    globals()['JsonApiParameterPatch'] = JsonApiParameterPatch


class JsonApiParameterPatchDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiParameterPatch,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiParameterPatchDocument - a model defined in OpenAPI
