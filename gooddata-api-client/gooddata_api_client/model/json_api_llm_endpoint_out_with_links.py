...
def lazy_import():
    ...
    globals()['JsonApiLlmEndpointOut'] = JsonApiLlmEndpointOut
    globals()['JsonApiLlmEndpointOutAttributes'] = JsonApiLlmEndpointOutAttributes
    globals()['ObjectLinks'] = ObjectLinks
    globals()['ObjectLinksContainer'] = ObjectLinksContainer


class JsonApiLlmEndpointOutWithLinks(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'attributes': (JsonApiLlmEndpointOutAttributes,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JsonApiLlmEndpointOutWithLinks - a model defined in OpenAPI

        Keyword Args:
            attributes (JsonApiLlmEndpointOutAttributes):
            id (str): API identifier of an object
            type (str): Object type. defaults to "llmEndpoint", must be one of ["llmEndpoint", ]  # noqa: E501
        ...
        type = kwargs.get('type', "llmEndpoint")
