...
class DeclarativeExportTemplates(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, export_templates, *args, **kwargs):  # noqa: E501
        """DeclarativeExportTemplates - a model defined in OpenAPI

        Args:
            export_templates ([DeclarativeExportTemplate]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, export_templates, *args, **kwargs):  # noqa: E501
        """DeclarativeExportTemplates - a model defined in OpenAPI
