...
def lazy_import():
    ...
    globals()['JsonApiAgentIn'] = JsonApiAgentIn


class JsonApiAgentInDocument(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiAgentInDocument - a model defined in OpenAPI
