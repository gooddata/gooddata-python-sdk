...
class AacMetric(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, maql, type, *args, **kwargs):  # noqa: E501
        """AacMetric - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, maql, type, *args, **kwargs):  # noqa: E501
        """AacMetric - a model defined in OpenAPI
