...
class OperationError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, detail, status, title, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, detail, status, title, *args, **kwargs):  # noqa: E501
        """OperationError - a model defined in OpenAPI
