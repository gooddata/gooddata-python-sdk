...
def lazy_import():
    ...
    globals()['JsonApiAutomationResultOut'] = JsonApiAutomationResultOut
...
class JsonApiAutomationResultOutWithLinks(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JsonApiAutomationResultOutWithLinks - a model defined in OpenAPI

        Keyword Args:
            attributes (JsonApiAutomationResultOutAttributes):
            id (str): API identifier of an object
            type (str): Object type. defaults to "automationResult", must be one of ["automationResult", ]  # noqa: E501
        ...
        type = kwargs.get('type', "automationResult")
