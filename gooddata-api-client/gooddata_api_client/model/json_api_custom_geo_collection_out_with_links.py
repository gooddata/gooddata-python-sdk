...
class JsonApiCustomGeoCollectionOutWithLinks(ModelComposed):
    ...
    allowed_values = {
        ('type',): {
            'CUSTOMGEOCOLLECTION': "customGeoCollection",
        },
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JsonApiCustomGeoCollectionOutWithLinks - a model defined in OpenAPI

        Keyword Args:
            id (str): API identifier of an object
            type (str): Object type. defaults to "customGeoCollection", must be one of ["customGeoCollection", ]  # noqa: E501
