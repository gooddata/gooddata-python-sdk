...
class ChatRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'chat_history_thread_id': (str,),  # noqa: E501
            ...
            'search_score_threshold': (float,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'chat_history_thread_id': 'chatHistoryThreadId',  # noqa: E501
        ...
        'search_score_threshold': 'searchScoreThreshold',  # noqa: E501
    ...
    def _from_openapi_data(cls, question, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            chat_history_thread_id (str): Chat History thread ID. Backend persists chat history and returns ID for further requests.. [optional]  # noqa: E501
            ...
            relevant_score_threshold (float): Score, above which we return found objects. Below this score objects are not relevant.. [optional] if omitted the server will use the default value of 0.4  # noqa: E501
            search_score_threshold (float): Score, above which we return found object(s) and don't call LLM to create new objects.. [optional] if omitted the server will use the default value of 0.9  # noqa: E501
            ...
            user_context (UserContext): [optional]  # noqa: E501
        """
