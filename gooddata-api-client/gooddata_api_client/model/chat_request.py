...
class ChatRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, question, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            object_types ([str]): List of object types to filter the search and visualization building. If empty or null, all object types are considered.. [optional]  # noqa: E501
            relevant_score_threshold (float): Score, above which we return found objects. Below this score objects are not relevant.. [optional] if omitted the server will use the default value of 0.45  # noqa: E501
