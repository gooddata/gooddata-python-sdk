...
def lazy_import():
    ...
    globals()['JsonApiIdentityProviderOut'] = JsonApiIdentityProviderOut
    globals()['ObjectLinks'] = ObjectLinks


class JsonApiIdentityProviderOutDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiIdentityProviderOut,),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiIdentityProviderOutDocument - a model defined in OpenAPI
