...
def lazy_import():
    ...
    globals()['JsonApiMemoryItemInAttributes'] = JsonApiMemoryItemInAttributes


class JsonApiMemoryItemPostOptionalId(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'attributes': (JsonApiMemoryItemInAttributes,),  # noqa: E501
            'type': (str,),  # noqa: E501
            'id': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, attributes, *args, **kwargs):  # noqa: E501
        """JsonApiMemoryItemPostOptionalId - a model defined in OpenAPI
