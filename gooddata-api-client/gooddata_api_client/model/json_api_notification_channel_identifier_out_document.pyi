...
class JsonApiNotificationChannelIdentifierOutDocument(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['JsonApiNotificationChannelIdentifierOut']:
                return JsonApiNotificationChannelIdentifierOut
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'JsonApiNotificationChannelIdentifierOut': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'JsonApiNotificationChannelIdentifierOut': ...
