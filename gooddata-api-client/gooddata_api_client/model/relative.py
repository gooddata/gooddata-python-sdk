...
def lazy_import():
    ...
    globals()['ArithmeticMeasure'] = ArithmeticMeasure
    globals()['Value'] = Value


class Relative(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'measure': (ArithmeticMeasure,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, measure, operator, threshold, *args, **kwargs):  # noqa: E501
        """Relative - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, measure, operator, threshold, *args, **kwargs):  # noqa: E501
        """Relative - a model defined in OpenAPI
