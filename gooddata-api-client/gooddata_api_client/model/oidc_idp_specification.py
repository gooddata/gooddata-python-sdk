...
class OidcIdpSpecification(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, oauth_client_id, oauth_client_secret, oauth_issuer_id, oauth_issuer_location, oauth_subject_id_claim, *args, **kwargs):  # noqa: E501
        """OidcIdpSpecification - a model defined in OpenAPI
        ...
        self.oauth_issuer_id = oauth_issuer_id
        self.oauth_issuer_location = oauth_issuer_location
        self.oauth_subject_id_claim = oauth_subject_id_claim
    ...
    @convert_js_args_to_python_args
    def __init__(self, oauth_client_id, oauth_client_secret, oauth_issuer_id, oauth_issuer_location, oauth_subject_id_claim, *args, **kwargs):  # noqa: E501
        """OidcIdpSpecification - a model defined in OpenAPI
