...
class JsonApiOrgMemoryItemOutAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, instruction, strategy, *args, **kwargs):  # noqa: E501
        """JsonApiOrgMemoryItemOutAttributes - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, instruction, strategy, *args, **kwargs):  # noqa: E501
        """JsonApiOrgMemoryItemOutAttributes - a model defined in OpenAPI
