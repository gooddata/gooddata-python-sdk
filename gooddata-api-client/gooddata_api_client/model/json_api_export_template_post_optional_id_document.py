...
def lazy_import():
    ...
    globals()['JsonApiExportTemplatePostOptionalId'] = JsonApiExportTemplatePostOptionalId


class JsonApiExportTemplatePostOptionalIdDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiExportTemplatePostOptionalId,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiExportTemplatePostOptionalIdDocument - a model defined in OpenAPI
