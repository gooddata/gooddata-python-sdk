...
class AacVisualizationBasicBuckets(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                def BULLET_CHART(cls):
                    return cls("bullet_chart")
                
                @schemas.classproperty
                def COMBO_CHART(cls):
                    return cls("combo_chart")
                
                @schemas.classproperty
                def DONUT_CHART(cls):
                    return cls("donut_chart")
                
                @schemas.classproperty
                def FUNNEL_CHART(cls):
                    return cls("funnel_chart")
                
                @schemas.classproperty
                def HEADLINE_CHART(cls):
                    return cls("headline_chart")
                ...
                @schemas.classproperty
                def PYRAMID_CHART(cls):
                    return cls("pyramid_chart")
                
                @schemas.classproperty
                def TREEMAP_CHART(cls):
                    return cls("treemap_chart")
                
                @schemas.classproperty
                def WATERFALL_CHART(cls):
                    return cls("waterfall_chart")
        ...
        class all_of_4(
            ...
            class MetaOapg:
                ...
                class not_schema(
                    ...
                    stack_by: schemas.AnyTypeSchema
