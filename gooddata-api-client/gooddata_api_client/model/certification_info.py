...
class CertificationInfo(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'certification_message': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, status, *args, **kwargs):  # noqa: E501
        """CertificationInfo - a model defined in OpenAPI

        Args:
            status (str): Certification status, e.g. CERTIFIED.
        ...
        Keyword Args:
            ...
            certification_message (str): Optional message describing the certification.. [optional]  # noqa: E501
        """
