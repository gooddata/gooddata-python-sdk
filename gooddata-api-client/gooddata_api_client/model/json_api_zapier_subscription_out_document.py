...
class JsonApiZapierSubscriptionOutDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiZapierSubscriptionOut,),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiZapierSubscriptionOutDocument - a model defined in OpenAPI

        Args:
            data (JsonApiZapierSubscriptionOut):
