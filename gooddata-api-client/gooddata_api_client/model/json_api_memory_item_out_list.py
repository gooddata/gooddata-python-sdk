...
def lazy_import():
    ...
    globals()['JsonApiMemoryItemOutWithLinks'] = JsonApiMemoryItemOutWithLinks
    globals()['JsonApiUserIdentifierOutWithLinks'] = JsonApiUserIdentifierOutWithLinks
    globals()['ListLinks'] = ListLinks


class JsonApiMemoryItemOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiMemoryItemOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiMemoryItemOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiMemoryItemOutWithLinks]):
