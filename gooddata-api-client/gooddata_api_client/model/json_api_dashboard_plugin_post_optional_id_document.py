...
def lazy_import():
    ...
    globals()['JsonApiDashboardPluginPostOptionalId'] = JsonApiDashboardPluginPostOptionalId


class JsonApiDashboardPluginPostOptionalIdDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiDashboardPluginPostOptionalId,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiDashboardPluginPostOptionalIdDocument - a model defined in OpenAPI
