...
class DashboardMatchAttributeFilterMatchAttributeFilter(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'display_form': (IdentifierRef,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, case_sensitive, display_form, literal, negative_selection, operator, *args, **kwargs):  # noqa: E501
        """DashboardMatchAttributeFilterMatchAttributeFilter - a model defined in OpenAPI

        Args:
            case_sensitive (bool):
            display_form (IdentifierRef):
            literal (str):
    ...
    @convert_js_args_to_python_args
    def __init__(self, case_sensitive, display_form, literal, negative_selection, operator, *args, **kwargs):  # noqa: E501
        """DashboardMatchAttributeFilterMatchAttributeFilter - a model defined in OpenAPI
