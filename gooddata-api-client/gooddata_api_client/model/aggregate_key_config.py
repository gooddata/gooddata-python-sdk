...
class AggregateKeyConfig(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AggregateKeyConfig - a model defined in OpenAPI

        Args:

        Keyword Args:
            type (str): defaults to "aggregate", must be one of ["aggregate", ]  # noqa: E501
        ...
        type = kwargs.get('type', "aggregate")
