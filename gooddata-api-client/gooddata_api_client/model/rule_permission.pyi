...
class RulePermission(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "permissions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "permissions", ], str]):
