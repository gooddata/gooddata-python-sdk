...
class JsonApiDataSourceTableOutList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JsonApiDataSourceTableOutWithLinks']:
                        return JsonApiDataSourceTableOutWithLinks

                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiDataSourceTableOutWithLinks'], typing.List['JsonApiDataSourceTableOutWithLinks']],
                ...
                def __getitem__(self, i: int) -> 'JsonApiDataSourceTableOutWithLinks':
...
from gooddata_api_client.models.json_api_data_source_table_out_with_links import JsonApiDataSourceTableOutWithLinks
