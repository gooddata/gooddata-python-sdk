...
def lazy_import():
    ...
    globals()['OidcIdpSpecification'] = OidcIdpSpecification
    globals()['SamlIdpSpecification'] = SamlIdpSpecification


class JsonApiIdentityProviderInAttributesSpecification(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JsonApiIdentityProviderInAttributesSpecification - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            metadata (str): Base64 encoded xml document with SAML metadata. This document is issued by your SAML provider. It includes the issuer's name, expiration information, and keys that can be used to validate the response from the identity provider.. [optional]  # noqa: E501
