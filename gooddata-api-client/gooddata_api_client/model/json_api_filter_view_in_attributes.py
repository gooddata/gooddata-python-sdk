...
class JsonApiFilterViewInAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, content, title, *args, **kwargs):  # noqa: E501
        """JsonApiFilterViewInAttributes - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, content, title, *args, **kwargs):  # noqa: E501
        """JsonApiFilterViewInAttributes - a model defined in OpenAPI
