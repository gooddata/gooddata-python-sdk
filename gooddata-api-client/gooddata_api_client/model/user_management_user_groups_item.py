...
class UserManagementUserGroupsItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, group_id, organization_admin, user_count, workspaces, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, group_id, organization_admin, user_count, workspaces, *args, **kwargs):  # noqa: E501
        """UserManagementUserGroupsItem - a model defined in OpenAPI
