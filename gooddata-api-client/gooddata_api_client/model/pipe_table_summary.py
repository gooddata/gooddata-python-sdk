...
class PipeTableSummary(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, columns, path_prefix, pipe_table_id, table_name, *args, **kwargs):  # noqa: E501
        """PipeTableSummary - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, columns, path_prefix, pipe_table_id, table_name, *args, **kwargs):  # noqa: E501
        """PipeTableSummary - a model defined in OpenAPI
