...
class TriggerQualityIssuesCalculationResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, process_id, status, *args, **kwargs):  # noqa: E501
        """TriggerQualityIssuesCalculationResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, process_id, status, *args, **kwargs):  # noqa: E501
        """TriggerQualityIssuesCalculationResponse - a model defined in OpenAPI
