...
def lazy_import():
    ...
    globals()['JsonApiWorkspaceThemeOutWithLinks'] = JsonApiWorkspaceThemeOutWithLinks
    globals()['ListLinks'] = ListLinks


class JsonApiWorkspaceThemeOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiWorkspaceThemeOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiWorkspaceThemeOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiWorkspaceThemeOutWithLinks]):
