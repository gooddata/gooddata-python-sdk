...
class DeclarativeAnalyticalDashboardPermissionForAssigneeAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DeclarativeAnalyticalDashboardPermissionForAssigneeAllOf - a model defined in OpenAPI
