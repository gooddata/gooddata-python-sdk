...
class JsonApiAutomationOutList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JsonApiAutomationOutWithLinks']:
                        return JsonApiAutomationOutWithLinks
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiAutomationOutWithLinks'], typing.List['JsonApiAutomationOutWithLinks']],
                ...
                def __getitem__(self, i: int) -> 'JsonApiAutomationOutWithLinks':
            ...
            class included(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JsonApiAutomationOutIncludes']:
                        return JsonApiAutomationOutIncludes
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiAutomationOutIncludes'], typing.List['JsonApiAutomationOutIncludes']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'included':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'JsonApiAutomationOutIncludes':
                    return super().__getitem__(i)
