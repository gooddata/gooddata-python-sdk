...
class NumberParameterDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, default_value, *args, **kwargs):  # noqa: E501
        """NumberParameterDefinition - a model defined in OpenAPI

        Args:
            default_value (float):

        Keyword Args:
            type (str): The parameter type.. defaults to "NUMBER", must be one of ["NUMBER", ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, default_value, *args, **kwargs):  # noqa: E501
        """NumberParameterDefinition - a model defined in OpenAPI
