...
def lazy_import():
    ...
    globals()['JsonApiComputedAttributePatch'] = JsonApiComputedAttributePatch


class JsonApiComputedAttributePatchDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiComputedAttributePatch,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiComputedAttributePatchDocument - a model defined in OpenAPI
