...
class JsonApiFilterContextPatchDocument(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['JsonApiFilterContextPatch']:
                return JsonApiFilterContextPatch
            __annotations__ = {
                "data": data,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'JsonApiFilterContextPatch': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'JsonApiFilterContextPatch': ...
