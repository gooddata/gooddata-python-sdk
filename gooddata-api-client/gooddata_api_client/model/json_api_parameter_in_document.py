...
def lazy_import():
    ...
    globals()['JsonApiParameterIn'] = JsonApiParameterIn


class JsonApiParameterInDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiParameterIn,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiParameterInDocument - a model defined in OpenAPI
