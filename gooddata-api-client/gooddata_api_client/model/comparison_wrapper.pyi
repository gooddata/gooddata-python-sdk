...
class ComparisonWrapper(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def comparison() -> typing.Type['Comparison']:
                return Comparison
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["comparison"]) -> 'Comparison': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["comparison"]) -> 'Comparison': ...
