...
class AacAttributeHierarchy(ModelNormal):
    ...
    def _from_openapi_data(cls, attributes, id, type, *args, **kwargs):  # noqa: E501
        """AacAttributeHierarchy - a model defined in OpenAPI

        Args:
            attributes ([str]): Ordered list of attribute identifiers (first is top level).
        ...
        Keyword Args:
            ...
            description (str): Attribute hierarchy description.. [optional]  # noqa: E501
