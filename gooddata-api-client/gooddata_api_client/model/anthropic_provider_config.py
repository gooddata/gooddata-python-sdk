...
class AnthropicProviderConfig(ModelNormal):
    ...
    def _from_openapi_data(cls, auth, *args, **kwargs):  # noqa: E501
        """AnthropicProviderConfig - a model defined in OpenAPI

        Args:
            auth (AnthropicProviderAuth):

        Keyword Args:
            type (str): Provider type.. defaults to "ANTHROPIC", must be one of ["ANTHROPIC", ]  # noqa: E501
            ...
            base_url (str): Custom base URL for the Anthropic API.. [optional] if omitted the server will use the default value of "https://api.anthropic.com"  # noqa: E501
        """

        type = kwargs.get('type', "ANTHROPIC")
