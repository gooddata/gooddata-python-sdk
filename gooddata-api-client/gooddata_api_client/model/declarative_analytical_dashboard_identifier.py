...
class DeclarativeAnalyticalDashboardIdentifier(ModelNormal):
    ...
    def _from_openapi_data(cls, id, *args, **kwargs):  # noqa: E501
        """DeclarativeAnalyticalDashboardIdentifier - a model defined in OpenAPI

        Args:
            id (str): Identifier of the analytical dashboard.

        Keyword Args:
            type (str): A type.. defaults to "analyticalDashboard", must be one of ["analyticalDashboard", ]  # noqa: E501
