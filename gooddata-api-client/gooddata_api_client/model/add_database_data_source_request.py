...
class AddDatabaseDataSourceRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data_source_id, *args, **kwargs):  # noqa: E501
        """AddDatabaseDataSourceRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data_source_name (str): Display name for the new data source in metadata-api. Defaults to dataSourceId when omitted.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, data_source_id, *args, **kwargs):  # noqa: E501
        """AddDatabaseDataSourceRequest - a model defined in OpenAPI
