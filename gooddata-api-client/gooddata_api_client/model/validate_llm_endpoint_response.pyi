...
class ValidateLLMEndpointResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["message", "successful", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["message", "successful", ], str]):
