...
def lazy_import():
    ...
    globals()['JsonApiWorkspaceColorPaletteOutWithLinks'] = JsonApiWorkspaceColorPaletteOutWithLinks
    globals()['ListLinks'] = ListLinks


class JsonApiWorkspaceColorPaletteOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiWorkspaceColorPaletteOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiWorkspaceColorPaletteOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiWorkspaceColorPaletteOutWithLinks]):
