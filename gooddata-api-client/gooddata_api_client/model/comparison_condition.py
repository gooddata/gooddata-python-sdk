...
class ComparisonCondition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, comparison, *args, **kwargs):  # noqa: E501
        """ComparisonCondition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, comparison, *args, **kwargs):  # noqa: E501
        """ComparisonCondition - a model defined in OpenAPI
