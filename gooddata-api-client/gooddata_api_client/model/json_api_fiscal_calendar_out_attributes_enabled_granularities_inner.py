...
class JsonApiFiscalCalendarOutAttributesEnabledGranularitiesInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, granularity, prefix, *args, **kwargs):  # noqa: E501
        """JsonApiFiscalCalendarOutAttributesEnabledGranularitiesInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, granularity, prefix, *args, **kwargs):  # noqa: E501
        """JsonApiFiscalCalendarOutAttributesEnabledGranularitiesInner - a model defined in OpenAPI
