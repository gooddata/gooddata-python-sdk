...
class ForecastRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, forecast_period, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            confidence_level (float): Confidence interval boundary value.. [optional] if omitted the server will use the default value of 0.95  # noqa: E501
            seasonal (bool): Whether the input data is seasonal. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, forecast_period, *args, **kwargs):  # noqa: E501
        """ForecastRequest - a model defined in OpenAPI
