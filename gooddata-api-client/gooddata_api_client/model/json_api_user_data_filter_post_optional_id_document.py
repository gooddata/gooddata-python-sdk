...
def lazy_import():
    ...
    globals()['JsonApiUserDataFilterPostOptionalId'] = JsonApiUserDataFilterPostOptionalId


class JsonApiUserDataFilterPostOptionalIdDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiUserDataFilterPostOptionalId,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiUserDataFilterPostOptionalIdDocument - a model defined in OpenAPI
