...
class AacAttributeHierarchy(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["attributes", "id", "type", "description", "tags", "title", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["attributes", "id", "type", "description", "tags", "title", ], str]):
