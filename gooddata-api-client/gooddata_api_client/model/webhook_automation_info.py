...
class WebhookAutomationInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dashboard_url, id, is_custom_dashboard_url, *args, **kwargs):  # noqa: E501
        """WebhookAutomationInfo - a model defined in OpenAPI
        ...
        self.id = id
        self.is_custom_dashboard_url = is_custom_dashboard_url
    ...
    @convert_js_args_to_python_args
    def __init__(self, dashboard_url, id, is_custom_dashboard_url, *args, **kwargs):  # noqa: E501
        """WebhookAutomationInfo - a model defined in OpenAPI
