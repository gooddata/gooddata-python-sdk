...
def lazy_import():
    ...
    globals()['JsonApiIdentityProviderToOneLinkage'] = JsonApiIdentityProviderToOneLinkage


class JsonApiOrganizationInRelationshipsIdentityProvider(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiIdentityProviderToOneLinkage,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiOrganizationInRelationshipsIdentityProvider - a model defined in OpenAPI

        Args:
            data (JsonApiIdentityProviderToOneLinkage):
