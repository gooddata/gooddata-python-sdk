...
class CompoundMeasureValueFilter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, compound_measure_value_filter, *args, **kwargs):  # noqa: E501
        """CompoundMeasureValueFilter - a model defined in OpenAPI

        Args:
            compound_measure_value_filter (CompoundMeasureValueFilterCompoundMeasureValueFilter):
        ...
        self.compound_measure_value_filter = compound_measure_value_filter
    ...
    @convert_js_args_to_python_args
    def __init__(self, compound_measure_value_filter, *args, **kwargs):  # noqa: E501
        """CompoundMeasureValueFilter - a model defined in OpenAPI
