...
def lazy_import():
    ...
    globals()['JsonApiWorkspaceExportTemplatePatch'] = JsonApiWorkspaceExportTemplatePatch


class JsonApiWorkspaceExportTemplatePatchDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiWorkspaceExportTemplatePatch,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiWorkspaceExportTemplatePatchDocument - a model defined in OpenAPI
