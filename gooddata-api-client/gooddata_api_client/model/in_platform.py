...
def lazy_import():
    ...
    globals()['InPlatformAllOf'] = InPlatformAllOf
...
class InPlatform(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InPlatform - a model defined in OpenAPI

        Keyword Args:
            type (str): The destination type.. defaults to "IN_PLATFORM", must be one of ["IN_PLATFORM", ]  # noqa: E501
        ...
        type = kwargs.get('type', "IN_PLATFORM")
