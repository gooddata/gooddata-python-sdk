...
class JsonApiCustomGeoCollectionOutDocument(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['JsonApiCustomGeoCollectionOut']:
                return JsonApiCustomGeoCollectionOut
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'JsonApiCustomGeoCollectionOut': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'JsonApiCustomGeoCollectionOut': ...
