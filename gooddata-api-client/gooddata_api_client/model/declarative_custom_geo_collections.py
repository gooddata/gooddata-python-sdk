...
class DeclarativeCustomGeoCollections(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, custom_geo_collections, *args, **kwargs):  # noqa: E501
        """DeclarativeCustomGeoCollections - a model defined in OpenAPI

        Args:
            custom_geo_collections ([DeclarativeCustomGeoCollection]):
        ...
        self.custom_geo_collections = custom_geo_collections
    ...
    @convert_js_args_to_python_args
    def __init__(self, custom_geo_collections, *args, **kwargs):  # noqa: E501
        """DeclarativeCustomGeoCollections - a model defined in OpenAPI
