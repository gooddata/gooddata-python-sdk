...
class StagingUploadLocation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, location, upload_url, *args, **kwargs):  # noqa: E501
        """StagingUploadLocation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, location, upload_url, *args, **kwargs):  # noqa: E501
        """StagingUploadLocation - a model defined in OpenAPI
