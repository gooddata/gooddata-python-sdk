...
class JsonApiDatasetOutAttributesWorkspaceDataFilterColumnsInner(ModelNormal):
    ...
    def _from_openapi_data(cls, data_type, name, *args, **kwargs):  # noqa: E501
        """JsonApiDatasetOutAttributesWorkspaceDataFilterColumnsInner - a model defined in OpenAPI
