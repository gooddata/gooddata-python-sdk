...
class JsonApiOrgMemoryItemOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiOrgMemoryItemOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiOrgMemoryItemOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiOrgMemoryItemOutWithLinks]):
