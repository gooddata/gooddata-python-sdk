...
class DashboardMatchAttributeFilter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, match_attribute_filter, *args, **kwargs):  # noqa: E501
        """DashboardMatchAttributeFilter - a model defined in OpenAPI

        Args:
            match_attribute_filter (DashboardMatchAttributeFilterMatchAttributeFilter):
        ...
        self.match_attribute_filter = match_attribute_filter
    ...
    @convert_js_args_to_python_args
    def __init__(self, match_attribute_filter, *args, **kwargs):  # noqa: E501
        """DashboardMatchAttributeFilter - a model defined in OpenAPI
