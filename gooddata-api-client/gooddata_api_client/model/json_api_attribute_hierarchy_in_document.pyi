...
class JsonApiAttributeHierarchyInDocument(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['JsonApiAttributeHierarchyIn']:
                return JsonApiAttributeHierarchyIn
            __annotations__ = {
                "data": data,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'JsonApiAttributeHierarchyIn': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'JsonApiAttributeHierarchyIn': ...
