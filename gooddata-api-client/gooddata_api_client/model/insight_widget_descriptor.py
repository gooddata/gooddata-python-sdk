...
class InsightWidgetDescriptor(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, visualization_id, widget_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, visualization_id, widget_id, *args, **kwargs):  # noqa: E501
        """InsightWidgetDescriptor - a model defined in OpenAPI
