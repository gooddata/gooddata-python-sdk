...
class DeclarativeFact(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "sourceColumn", "title", "description", "sourceColumnDataType", "tags", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "sourceColumn", "title", "description", "sourceColumnDataType", "tags", ], str]):
