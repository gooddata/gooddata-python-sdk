...
def lazy_import():
    ...
    globals()['JsonApiExportTemplateOutWithLinks'] = JsonApiExportTemplateOutWithLinks
    globals()['ListLinks'] = ListLinks


class JsonApiExportTemplateOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiExportTemplateOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiExportTemplateOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiExportTemplateOutWithLinks]):
