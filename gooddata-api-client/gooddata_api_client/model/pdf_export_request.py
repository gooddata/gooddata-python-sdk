...
class PdfExportRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, dashboard_id, file_name, *args, **kwargs):  # noqa: E501
        """PdfExportRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Metadata definition in open form JSON format.. [optional]  # noqa: E501
        """
