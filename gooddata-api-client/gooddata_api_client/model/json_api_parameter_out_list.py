...
class JsonApiParameterOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiParameterOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiParameterOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiParameterOutWithLinks]):
