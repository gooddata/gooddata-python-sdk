...
class DeclarativeUserDataFilter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, maql, title, *args, **kwargs):  # noqa: E501
        """DeclarativeUserDataFilter - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, maql, title, *args, **kwargs):  # noqa: E501
        """DeclarativeUserDataFilter - a model defined in OpenAPI
