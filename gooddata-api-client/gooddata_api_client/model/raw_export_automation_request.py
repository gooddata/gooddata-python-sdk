...
class RawExportAutomationRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, execution, file_name, format, *args, **kwargs):  # noqa: E501
        """RawExportAutomationRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, execution, file_name, format, *args, **kwargs):  # noqa: E501
        """RawExportAutomationRequest - a model defined in OpenAPI
