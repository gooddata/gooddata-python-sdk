...
class ObjectStorageInfo(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'storage_config': ({str: (str,)},),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, storage_config, storage_id, storage_type, *args, **kwargs):  # noqa: E501
        """ObjectStorageInfo - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, storage_config, storage_id, storage_type, *args, **kwargs):  # noqa: E501
        """ObjectStorageInfo - a model defined in OpenAPI
