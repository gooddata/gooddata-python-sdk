...
class JsonApiAggregatedFactOutList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    def items() -> typing.Type['JsonApiAggregatedFactOutWithLinks']:
                        return JsonApiAggregatedFactOutWithLinks
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiAggregatedFactOutWithLinks'], typing.List['JsonApiAggregatedFactOutWithLinks']],
                ...
                def __getitem__(self, i: int) -> 'JsonApiAggregatedFactOutWithLinks':
            ...
            class included(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JsonApiAggregatedFactOutIncludes']:
                        return JsonApiAggregatedFactOutIncludes
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiAggregatedFactOutIncludes'], typing.List['JsonApiAggregatedFactOutIncludes']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'included':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'JsonApiAggregatedFactOutIncludes':
                    return super().__getitem__(i)
