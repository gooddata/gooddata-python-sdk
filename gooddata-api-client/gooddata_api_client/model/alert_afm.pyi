...
class AlertAfm(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["filters", "measures", "attributes", "auxMeasures", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["filters", "measures", "attributes", "auxMeasures", ], str]):
