...
class IpAllowlistPolicyTargets(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'targets': ([AssigneeIdentifier],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, targets, *args, **kwargs):  # noqa: E501
        """IpAllowlistPolicyTargets - a model defined in OpenAPI

        Args:
            targets ([AssigneeIdentifier]):
