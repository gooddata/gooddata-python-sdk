...
def lazy_import():
    ...
    globals()['JsonApiLlmEndpointInAttributes'] = JsonApiLlmEndpointInAttributes


class JsonApiLlmEndpointIn(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'attributes': (JsonApiLlmEndpointInAttributes,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, attributes, id, *args, **kwargs):  # noqa: E501
        """JsonApiLlmEndpointIn - a model defined in OpenAPI
