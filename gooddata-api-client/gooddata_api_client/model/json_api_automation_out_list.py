...
class JsonApiAutomationOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiAutomationOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiAutomationOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiAutomationOutWithLinks]):
