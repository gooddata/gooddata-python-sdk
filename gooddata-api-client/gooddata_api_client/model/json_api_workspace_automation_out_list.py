...
class JsonApiWorkspaceAutomationOutList(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiWorkspaceAutomationOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiWorkspaceAutomationOutWithLinks]):
