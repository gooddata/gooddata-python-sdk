...
class JsonApiAutomationResultOutAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, executed_at, status, *args, **kwargs):  # noqa: E501
        """JsonApiAutomationResultOutAttributes - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, executed_at, status, *args, **kwargs):  # noqa: E501
        """JsonApiAutomationResultOutAttributes - a model defined in OpenAPI
