...
def lazy_import():
    ...
    globals()['JsonApiMemoryItemPatch'] = JsonApiMemoryItemPatch


class JsonApiMemoryItemPatchDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiMemoryItemPatch,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiMemoryItemPatchDocument - a model defined in OpenAPI
