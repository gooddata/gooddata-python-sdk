...
def lazy_import():
    ...
    globals()['JsonApiCustomUserApplicationSettingOutWithLinks'] = JsonApiCustomUserApplicationSettingOutWithLinks
    globals()['ListLinks'] = ListLinks


class JsonApiCustomUserApplicationSettingOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiCustomUserApplicationSettingOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiCustomUserApplicationSettingOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiCustomUserApplicationSettingOutWithLinks]):
