...
class GrantedPermission(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, level, source, *args, **kwargs):  # noqa: E501
        """GrantedPermission - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, level, source, *args, **kwargs):  # noqa: E501
        """GrantedPermission - a model defined in OpenAPI
