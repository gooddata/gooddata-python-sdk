        ...
        class properties:
            ...
            class labels(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def additional_properties() -> typing.Type['RawCustomLabel']:
                        return RawCustomLabel
                
                def __getitem__(self, name: typing.Union[str, ]) -> 'RawCustomLabel':
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                
                def get_item_oapg(self, name: typing.Union[str, ]) -> 'RawCustomLabel':
            ...
            class metrics(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def additional_properties() -> typing.Type['RawCustomMetric']:
                        return RawCustomMetric
                
                def __getitem__(self, name: typing.Union[str, ]) -> 'RawCustomMetric':
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                
                def get_item_oapg(self, name: typing.Union[str, ]) -> 'RawCustomMetric':
                    return super().get_item_oapg(name)
