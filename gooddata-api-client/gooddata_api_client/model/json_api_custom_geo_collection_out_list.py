...
def lazy_import():
    ...
    globals()['JsonApiCustomGeoCollectionOutWithLinks'] = JsonApiCustomGeoCollectionOutWithLinks
    globals()['ListLinks'] = ListLinks


class JsonApiCustomGeoCollectionOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiCustomGeoCollectionOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiCustomGeoCollectionOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiCustomGeoCollectionOutWithLinks]):
