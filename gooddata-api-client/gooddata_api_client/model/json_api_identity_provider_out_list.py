...
def lazy_import():
    ...
    globals()['JsonApiIdentityProviderOutWithLinks'] = JsonApiIdentityProviderOutWithLinks
    globals()['ListLinks'] = ListLinks


class JsonApiIdentityProviderOutList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([JsonApiIdentityProviderOutWithLinks],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiIdentityProviderOutList - a model defined in OpenAPI

        Args:
            data ([JsonApiIdentityProviderOutWithLinks]):
