...
class JsonApiDataSourceTableOutDocument(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['JsonApiDataSourceTableOut']:
                return JsonApiDataSourceTableOut
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'JsonApiDataSourceTableOut': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'JsonApiDataSourceTableOut': ...
...
from gooddata_api_client.models.json_api_data_source_table_out import JsonApiDataSourceTableOut
