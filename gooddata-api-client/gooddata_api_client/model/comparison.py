...
def lazy_import():
    ...
    globals()['AlertConditionOperand'] = AlertConditionOperand
    globals()['LocalIdentifier'] = LocalIdentifier


class Comparison(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'left': (LocalIdentifier,),  # noqa: E501
            'operator': (str,),  # noqa: E501
            'right': (AlertConditionOperand,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, left, operator, right, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, left, operator, right, *args, **kwargs):  # noqa: E501
        """Comparison - a model defined in OpenAPI
