...
class VisualizationSwitcherWidgetDescriptor(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, active_visualization_id, title, visualization_ids, widget_id, *args, **kwargs):  # noqa: E501
        ...
        self.active_visualization_id = active_visualization_id
        self.title = title
    ...
    @convert_js_args_to_python_args
    def __init__(self, active_visualization_id, title, visualization_ids, widget_id, *args, **kwargs):  # noqa: E501
        """VisualizationSwitcherWidgetDescriptor - a model defined in OpenAPI
