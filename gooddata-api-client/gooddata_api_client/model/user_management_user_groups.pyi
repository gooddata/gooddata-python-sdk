...
class UserManagementUserGroups(
    schemas.DictSchema
):
            ...
            class userGroups(
                ...
                class MetaOapg:
                    ...
                    def items() -> typing.Type['UserManagementUserGroupsItem']:
                        return UserManagementUserGroupsItem
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['UserManagementUserGroupsItem'], typing.List['UserManagementUserGroupsItem']],
                ...
                def __getitem__(self, i: int) -> 'UserManagementUserGroupsItem':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["totalCount", "userGroups", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["totalCount", "userGroups", ], str]):
