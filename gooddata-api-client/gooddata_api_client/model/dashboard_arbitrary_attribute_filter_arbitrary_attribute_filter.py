...
class DashboardArbitraryAttributeFilterArbitraryAttributeFilter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, display_form, negative_selection, values, *args, **kwargs):  # noqa: E501
        """DashboardArbitraryAttributeFilterArbitraryAttributeFilter - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, display_form, negative_selection, values, *args, **kwargs):  # noqa: E501
        """DashboardArbitraryAttributeFilterArbitraryAttributeFilter - a model defined in OpenAPI
