...
class ExecutionLinks(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["executionResult", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["executionResult", ], str]):
