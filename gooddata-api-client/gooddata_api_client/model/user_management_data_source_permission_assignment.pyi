...
class UserManagementDataSourcePermissionAssignment(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "permissions", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "permissions", "name", ], str]):
