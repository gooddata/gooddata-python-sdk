...
def lazy_import():
    ...
    globals()['HistogramBucket'] = HistogramBucket


class Histogram(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'buckets': ([HistogramBucket],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, buckets, *args, **kwargs):  # noqa: E501
