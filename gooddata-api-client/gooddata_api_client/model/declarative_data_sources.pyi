...
class DeclarativeDataSources(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dataSources", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dataSources", ], str]):
