...
class JsonApiLlmEndpointInAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, token, *args, **kwargs):  # noqa: E501
        """JsonApiLlmEndpointInAttributes - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, token, *args, **kwargs):  # noqa: E501
        """JsonApiLlmEndpointInAttributes - a model defined in OpenAPI
