...
class JsonApiUserGroupOutDocument(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['JsonApiUserGroupOut']:
                return JsonApiUserGroupOut
            ...
            class included(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JsonApiUserGroupOutWithLinks']:
                        return JsonApiUserGroupOutWithLinks
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiUserGroupOutWithLinks'], typing.List['JsonApiUserGroupOutWithLinks']],
                ...
                def __getitem__(self, i: int) -> 'JsonApiUserGroupOutWithLinks':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'JsonApiUserGroupOut': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'JsonApiUserGroupOut': ...
