...
class KeyDriversDimension(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, attribute, attribute_name, label, label_name, *args, **kwargs):  # noqa: E501
        """KeyDriversDimension - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, attribute, attribute_name, label, label_name, *args, **kwargs):  # noqa: E501
        """KeyDriversDimension - a model defined in OpenAPI
