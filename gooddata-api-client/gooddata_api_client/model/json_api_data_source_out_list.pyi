...
class JsonApiDataSourceOutList(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class data(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['JsonApiDataSourceOutWithLinks'], typing.List['JsonApiDataSourceOutWithLinks']],
                ...
                def __getitem__(self, i: int) -> 'JsonApiDataSourceOutWithLinks':
