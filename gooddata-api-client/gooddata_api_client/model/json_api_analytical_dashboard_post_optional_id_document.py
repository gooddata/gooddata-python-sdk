...
def lazy_import():
    ...
    globals()['JsonApiAnalyticalDashboardPostOptionalId'] = JsonApiAnalyticalDashboardPostOptionalId


class JsonApiAnalyticalDashboardPostOptionalIdDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiAnalyticalDashboardPostOptionalId,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiAnalyticalDashboardPostOptionalIdDocument - a model defined in OpenAPI
