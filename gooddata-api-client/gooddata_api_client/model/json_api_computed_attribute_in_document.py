...
def lazy_import():
    ...
    globals()['JsonApiComputedAttributeIn'] = JsonApiComputedAttributeIn


class JsonApiComputedAttributeInDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiComputedAttributeIn,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiComputedAttributeInDocument - a model defined in OpenAPI
