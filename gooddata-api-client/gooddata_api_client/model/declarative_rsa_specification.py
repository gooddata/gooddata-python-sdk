...
class DeclarativeRsaSpecification(ModelNormal):
    ...
    def _from_openapi_data(cls, alg, e, kid, n, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            use (str): Parameter identifies the intended use of the public key.. defaults to "sig", must be one of ["sig", ]  # noqa: E501
