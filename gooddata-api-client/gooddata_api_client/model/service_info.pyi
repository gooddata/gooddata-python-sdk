...
class ServiceInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "serviceId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "serviceId", ], str]):
