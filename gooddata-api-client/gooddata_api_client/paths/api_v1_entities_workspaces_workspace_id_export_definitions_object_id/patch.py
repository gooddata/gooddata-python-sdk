...
# body param
SchemaForRequestBodyApplicationJson = JsonApiExportDefinitionPatchDocument
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiExportDefinitionPatchDocument


request_body_json_api_export_definition_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JsonApiExportDefinitionOutDocument
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiExportDefinitionOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_export_definitions_oapg(
        self,
    ...
    def _patch_entity_export_definitions_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_export_definition_patch_document.serialize(body, content_type)
...
class PatchEntityExportDefinitions(BaseApi):
    ...
    def patch_entity_export_definitions(
        ...
        return self._patch_entity_export_definitions_oapg(
            body=body,
