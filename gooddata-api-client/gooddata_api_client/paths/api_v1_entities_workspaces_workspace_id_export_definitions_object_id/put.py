...
# body param
SchemaForRequestBodyApplicationJson = JsonApiExportDefinitionInDocument
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiExportDefinitionInDocument


request_body_json_api_export_definition_in_document = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_entity_export_definitions_oapg(
        self,
    ...
    def _update_entity_export_definitions_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_export_definition_in_document.serialize(body, content_type)
...
class UpdateEntityExportDefinitions(BaseApi):
    ...
    def update_entity_export_definitions(
        ...
        return self._update_entity_export_definitions_oapg(
            body=body,
