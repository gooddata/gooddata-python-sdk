...
SchemaFor200ResponseBodyApplicationJson = DeclarativeWorkspacePermissions
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_workspace_permissions_oapg(
        self,
...
class GetWorkspacePermissions(BaseApi):
    ...
    def get_workspace_permissions(
        ...
        return self._get_workspace_permissions_oapg(
