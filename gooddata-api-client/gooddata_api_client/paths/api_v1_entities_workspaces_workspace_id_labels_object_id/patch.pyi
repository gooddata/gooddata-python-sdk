...
# body param
SchemaForRequestBodyApplicationJson = JsonApiLabelPatchDocument
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiLabelPatchDocument


request_body_json_api_label_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JsonApiLabelOutDocument
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiLabelOutDocument
...
class BaseApi(api_client.Api):
    ...
    def _patch_entity_labels_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_label_patch_document.serialize(body, content_type)
...
class PatchEntityLabels(BaseApi):
    ...
    def patch_entity_labels(
        ...
        return self._patch_entity_labels_oapg(
            body=body,
