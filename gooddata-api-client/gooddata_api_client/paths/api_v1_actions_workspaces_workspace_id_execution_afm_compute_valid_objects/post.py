...
# body param
SchemaForRequestBodyApplicationJson = AfmValidObjectsQuery


request_body_afm_valid_objects_query = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AfmValidObjectsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _compute_valid_objects_oapg(
        self,
    ...
    def _compute_valid_objects_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_afm_valid_objects_query.serialize(body, content_type)
...
class ComputeValidObjects(BaseApi):
    ...
    def compute_valid_objects(
        ...
        return self._compute_valid_objects_oapg(
            body=body,
