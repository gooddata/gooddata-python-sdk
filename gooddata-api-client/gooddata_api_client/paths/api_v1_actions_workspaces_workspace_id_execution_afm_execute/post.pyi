...
request_header_timestamp = api_client.HeaderParameter(
    name="timestamp",
    style=api_client.ParameterStyle.SIMPLE,
...
SchemaFor200ResponseBodyApplicationJson = AfmExecutionResponse
...
class ComputeReport(BaseApi):
    ...
    def compute_report(
        ...
        return self._compute_report_oapg(
            body=body,
