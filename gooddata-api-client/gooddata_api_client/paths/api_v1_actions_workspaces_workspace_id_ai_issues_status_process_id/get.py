...
SchemaFor200ResponseBodyApplicationJson = QualityIssuesCalculationStatusResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_quality_issues_calculation_status_oapg(
        self,
...
class GetQualityIssuesCalculationStatus(BaseApi):
    ...
    def get_quality_issues_calculation_status(
        ...
        return self._get_quality_issues_calculation_status_oapg(
