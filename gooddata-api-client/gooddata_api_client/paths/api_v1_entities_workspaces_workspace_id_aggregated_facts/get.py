...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_aggregated_facts_oapg(
        self,
...
class GetAllEntitiesAggregatedFacts(BaseApi):
    ...
    def get_all_entities_aggregated_facts(
        ...
        return self._get_all_entities_aggregated_facts_oapg(
