...
SchemaFor200ResponseBodyApplicationJson = JsonApiMemoryItemOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiMemoryItemOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_memory_items_oapg(
        self,
...
class SearchEntitiesMemoryItems(BaseApi):
    ...
    def search_entities_memory_items(
        ...
        return self._search_entities_memory_items_oapg(
            body=body,
