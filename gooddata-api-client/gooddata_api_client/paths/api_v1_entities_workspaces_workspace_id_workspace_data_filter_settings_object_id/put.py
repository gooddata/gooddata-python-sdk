...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_entity_workspace_data_filter_settings_oapg(
        self,
...
class UpdateEntityWorkspaceDataFilterSettings(BaseApi):
    ...
    def update_entity_workspace_data_filter_settings(
        ...
        return self._update_entity_workspace_data_filter_settings_oapg(
            body=body,
