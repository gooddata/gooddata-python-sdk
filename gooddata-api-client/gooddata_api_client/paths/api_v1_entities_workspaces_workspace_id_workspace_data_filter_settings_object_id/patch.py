...
# body param
SchemaForRequestBodyApplicationJson = JsonApiWorkspaceDataFilterSettingPatchDocument
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiWorkspaceDataFilterSettingPatchDocument


request_body_json_api_workspace_data_filter_setting_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JsonApiWorkspaceDataFilterSettingOutDocument
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiWorkspaceDataFilterSettingOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_workspace_data_filter_settings_oapg(
        self,
    ...
    def _patch_entity_workspace_data_filter_settings_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_workspace_data_filter_setting_patch_document.serialize(body, content_type)
...
class PatchEntityWorkspaceDataFilterSettings(BaseApi):
    ...
    def patch_entity_workspace_data_filter_settings(
        ...
        return self._patch_entity_workspace_data_filter_settings_oapg(
            body=body,
