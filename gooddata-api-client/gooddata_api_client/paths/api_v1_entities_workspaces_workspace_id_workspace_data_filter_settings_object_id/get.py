...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_entity_workspace_data_filter_settings_oapg(
        self,
...
class GetEntityWorkspaceDataFilterSettings(BaseApi):
    ...
    def get_entity_workspace_data_filter_settings(
        ...
        return self._get_entity_workspace_data_filter_settings_oapg(
