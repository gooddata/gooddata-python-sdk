...
SchemaFor200ResponseBodyApplicationJson = JsonApiAttributeHierarchyOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiAttributeHierarchyOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_attribute_hierarchies_oapg(
        self,
...
class SearchEntitiesAttributeHierarchies(BaseApi):
    ...
    def search_entities_attribute_hierarchies(
        ...
        return self._search_entities_attribute_hierarchies_oapg(
            body=body,
