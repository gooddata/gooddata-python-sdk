...
SchemaFor200ResponseBodyApplicationJson = JsonApiDatasetOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_datasets_oapg(
        self,
...
class SearchEntitiesDatasets(BaseApi):
    ...
    def search_entities_datasets(
        ...
        return self._search_entities_datasets_oapg(
            body=body,
