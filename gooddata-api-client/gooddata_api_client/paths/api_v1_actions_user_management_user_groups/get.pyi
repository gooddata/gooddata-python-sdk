...
DataSourceSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'dataSource': typing.Union[DataSourceSchema, str, ],
    },
    total=False
)
...
request_query_data_source = api_client.QueryParameter(
    name="dataSource",
    style=api_client.ParameterStyle.FORM,
    schema=DataSourceSchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationJson = UserManagementUserGroups
