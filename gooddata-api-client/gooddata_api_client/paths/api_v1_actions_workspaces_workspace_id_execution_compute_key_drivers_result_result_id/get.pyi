...
SchemaFor200ResponseBodyApplicationJson = KeyDriversResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _key_driver_analysis_result_oapg(
        self,
...
class KeyDriverAnalysisResult(BaseApi):
    ...
    def key_driver_analysis_result(
        ...
        return self._key_driver_analysis_result_oapg(
