...
# body param
SchemaForRequestBodyApplicationJson = TabularExportRequest


request_body_tabular_export_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_tabular_export_oapg(
        self,
    ...
    def _create_tabular_export_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tabular_export_request.serialize(body, content_type)
...
class CreateTabularExport(BaseApi):
    ...
    def create_tabular_export(
        ...
        return self._create_tabular_export_oapg(
            body=body,
