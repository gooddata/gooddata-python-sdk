...
SchemaFor200ResponseBodyApplicationJson = JsonApiFactOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiFactOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_facts_oapg(
        self,
...
class SearchEntitiesFacts(BaseApi):
    ...
    def search_entities_facts(
        ...
        return self._search_entities_facts_oapg(
            body=body,
