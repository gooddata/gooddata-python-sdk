...
SchemaFor200ResponseBodyApplicationJson = JsonApiUserDataFilterOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiUserDataFilterOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_user_data_filters_oapg(
        self,
...
class SearchEntitiesUserDataFilters(BaseApi):
    ...
    def search_entities_user_data_filters(
        ...
        return self._search_entities_user_data_filters_oapg(
            body=body,
