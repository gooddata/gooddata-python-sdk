...
SchemaFor200ResponseBodyApplicationJson = TriggerQualityIssuesCalculationResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _trigger_quality_issues_calculation_oapg(
        self,
...
class TriggerQualityIssuesCalculation(BaseApi):
    ...
    def trigger_quality_issues_calculation(
        ...
        return self._trigger_quality_issues_calculation_oapg(
