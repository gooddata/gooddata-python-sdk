...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiUserOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_users_oapg(
        self,
...
class GetAllEntitiesUsers(BaseApi):
    ...
    def get_all_entities_users(
        ...
        return self._get_all_entities_users_oapg(
