...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiFilterContextPostOptionalIdDocument


request_body_json_api_filter_context_post_optional_id_document = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndGooddataApijson = JsonApiFilterContextOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_entity_filter_contexts_oapg(
        self,
    ...
    def _create_entity_filter_contexts_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_filter_context_post_optional_id_document.serialize(body, content_type)
...
class CreateEntityFilterContexts(BaseApi):
    ...
    def create_entity_filter_contexts(
        ...
        return self._create_entity_filter_contexts_oapg(
            body=body,
