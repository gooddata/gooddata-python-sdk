...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiUserGroupPatchDocument


request_body_json_api_user_group_patch_document = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_user_groups_oapg(
        self,
    ...
    def _patch_entity_user_groups_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_user_group_patch_document.serialize(body, content_type)
...
class PatchEntityUserGroups(BaseApi):
    ...
    def patch_entity_user_groups(
        ...
        return self._patch_entity_user_groups_oapg(
            body=body,
