...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiUserGroupOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_entity_user_groups_oapg(
        self,
...
class UpdateEntityUserGroups(BaseApi):
    ...
    def update_entity_user_groups(
        ...
        return self._update_entity_user_groups_oapg(
            body=body,
