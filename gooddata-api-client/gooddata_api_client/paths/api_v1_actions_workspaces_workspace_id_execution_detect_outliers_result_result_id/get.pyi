...
SchemaFor200ResponseBodyApplicationJson = OutlierDetectionResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _outlier_detection_result_oapg(
        self,
...
class OutlierDetectionResult(BaseApi):
    ...
    def outlier_detection_result(
        ...
        return self._outlier_detection_result_oapg(
