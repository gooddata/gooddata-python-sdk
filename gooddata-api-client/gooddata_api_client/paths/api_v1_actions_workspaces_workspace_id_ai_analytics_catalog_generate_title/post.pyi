...
# body param
SchemaForRequestBodyApplicationJson = GenerateTitleRequest


request_body_generate_title_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GenerateTitleResponse
...
class BaseApi(api_client.Api):
    ...
    def _generate_title_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_generate_title_request.serialize(body, content_type)
...
class GenerateTitle(BaseApi):
    ...
    def generate_title(
        ...
        return self._generate_title_oapg(
            body=body,
