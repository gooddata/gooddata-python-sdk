...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiOrganizationInDocument


request_body_json_api_organization_in_document = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_entity_organizations_oapg(
        self,
    ...
    def _update_entity_organizations_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_organization_in_document.serialize(body, content_type)
...
class UpdateEntityOrganizations(BaseApi):
    ...
    def update_entity_organizations(
        ...
        return self._update_entity_organizations_oapg(
            body=body,
