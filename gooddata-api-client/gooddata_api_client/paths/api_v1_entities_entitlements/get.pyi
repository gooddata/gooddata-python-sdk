...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiEntitlementOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_entitlements_oapg(
        self,
...
class GetAllEntitiesEntitlements(BaseApi):
    ...
    def get_all_entities_entitlements(
        ...
        return self._get_all_entities_entitlements_oapg(
