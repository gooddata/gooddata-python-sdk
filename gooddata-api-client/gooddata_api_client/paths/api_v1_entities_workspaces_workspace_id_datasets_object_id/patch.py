        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    ...
                    "facts": "FACTS",
                    "aggregatedFacts": "AGGREGATED_FACTS",
                    "datasets": "DATASETS",
            ...
            @schemas.classproperty
            def AGGREGATED_FACTS(cls):
                return cls("aggregatedFacts")
...
# body param
SchemaForRequestBodyApplicationJson = JsonApiDatasetPatchDocument
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiDatasetPatchDocument


request_body_json_api_dataset_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JsonApiDatasetOutDocument
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiDatasetOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_datasets_oapg(
        self,
    ...
    def _patch_entity_datasets_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_dataset_patch_document.serialize(body, content_type)
...
class PatchEntityDatasets(BaseApi):
    ...
    def patch_entity_datasets(
        ...
        return self._patch_entity_datasets_oapg(
            body=body,
