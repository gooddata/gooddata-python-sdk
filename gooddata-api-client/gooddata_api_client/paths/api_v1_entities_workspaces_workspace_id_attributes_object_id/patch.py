        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    "datasets": "DATASETS",
                    "labels": "LABELS",
                    "attributeHierarchies": "ATTRIBUTE_HIERARCHIES",
                    "dataset": "DATASET",
            ...
            @schemas.classproperty
            def ATTRIBUTE_HIERARCHIES(cls):
                return cls("attributeHierarchies")
...
# body param
SchemaForRequestBodyApplicationJson = JsonApiAttributePatchDocument
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiAttributePatchDocument


request_body_json_api_attribute_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JsonApiAttributeOutDocument
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiAttributeOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_attributes_oapg(
        self,
    ...
    def _patch_entity_attributes_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_attribute_patch_document.serialize(body, content_type)
...
class PatchEntityAttributes(BaseApi):
    ...
    def patch_entity_attributes(
        ...
        return self._patch_entity_attributes_oapg(
            body=body,
