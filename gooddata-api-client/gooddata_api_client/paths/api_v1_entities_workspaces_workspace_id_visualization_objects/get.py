...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_visualization_objects_oapg(
        self,
...
class GetAllEntitiesVisualizationObjects(BaseApi):
    ...
    def get_all_entities_visualization_objects(
        ...
        return self._get_all_entities_visualization_objects_oapg(
