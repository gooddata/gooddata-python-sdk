...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiVisualizationObjectPostOptionalIdDocument


request_body_json_api_visualization_object_post_optional_id_document = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndGooddataApijson = JsonApiVisualizationObjectOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_entity_visualization_objects_oapg(
        self,
    ...
    def _create_entity_visualization_objects_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_visualization_object_post_optional_id_document.serialize(body, content_type)
...
class CreateEntityVisualizationObjects(BaseApi):
    ...
    def create_entity_visualization_objects(
        ...
        return self._create_entity_visualization_objects_oapg(
            body=body,
