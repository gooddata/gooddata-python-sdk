...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiUserDataFilterPostOptionalIdDocument


request_body_json_api_user_data_filter_post_optional_id_document = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndGooddataApijson = JsonApiUserDataFilterOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_entity_user_data_filters_oapg(
        self,
    ...
    def _create_entity_user_data_filters_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_user_data_filter_post_optional_id_document.serialize(body, content_type)
...
class CreateEntityUserDataFilters(BaseApi):
    ...
    def create_entity_user_data_filters(
        ...
        return self._create_entity_user_data_filters_oapg(
            body=body,
