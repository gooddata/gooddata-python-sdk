...
# body param
SchemaForRequestBodyApplicationJson = ChangeAnalysisRequest


request_body_change_analysis_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ChangeAnalysisResponse
...
class BaseApi(api_client.Api):
    ...
    def _change_analysis_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_change_analysis_request.serialize(body, content_type)
...
class ChangeAnalysis(BaseApi):
    ...
    def change_analysis(
        ...
        return self._change_analysis_oapg(
            body=body,
