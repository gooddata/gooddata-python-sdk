...
# body param
SchemaForRequestBodyApplicationJson = AfmValidDescendantsQuery


request_body_afm_valid_descendants_query = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AfmValidDescendantsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _compute_valid_descendants_oapg(
        self,
    ...
    def _compute_valid_descendants_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_afm_valid_descendants_query.serialize(body, content_type)
...
class ComputeValidDescendants(BaseApi):
    ...
    def compute_valid_descendants(
        ...
        return self._compute_valid_descendants_oapg(
            body=body,
