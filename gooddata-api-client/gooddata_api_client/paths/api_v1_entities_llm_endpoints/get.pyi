...
SchemaFor200ResponseBodyApplicationJson = JsonApiLlmEndpointOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiLlmEndpointOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_llm_endpoints_oapg(
        self,
...
class GetAllEntitiesLlmEndpoints(BaseApi):
    ...
    def get_all_entities_llm_endpoints(
        ...
        return self._get_all_entities_llm_endpoints_oapg(
