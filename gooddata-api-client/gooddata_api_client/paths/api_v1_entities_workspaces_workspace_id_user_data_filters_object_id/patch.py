...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiUserDataFilterPatchDocument


request_body_json_api_user_data_filter_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiUserDataFilterOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_user_data_filters_oapg(
        self,
    ...
    def _patch_entity_user_data_filters_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_user_data_filter_patch_document.serialize(body, content_type)
...
class PatchEntityUserDataFilters(BaseApi):
    ...
    def patch_entity_user_data_filters(
        ...
        return self._patch_entity_user_data_filters_oapg(
            body=body,
