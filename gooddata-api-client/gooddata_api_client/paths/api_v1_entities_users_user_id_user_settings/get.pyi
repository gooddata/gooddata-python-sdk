...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiUserSettingOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_user_settings_oapg(
        self,
...
class GetAllEntitiesUserSettings(BaseApi):
    ...
    def get_all_entities_user_settings(
        ...
        return self._get_all_entities_user_settings_oapg(
