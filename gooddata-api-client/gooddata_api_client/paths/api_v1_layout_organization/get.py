...
SchemaFor200ResponseBodyApplicationJson = DeclarativeOrganization
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_organization_layout_oapg(
        self,
...
class GetOrganizationLayout(BaseApi):
    ...
    def get_organization_layout(
        ...
        return self._get_organization_layout_oapg(
