...
SchemaFor200ResponseBodyApplicationJson = JsonApiKnowledgeRecommendationOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiKnowledgeRecommendationOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_knowledge_recommendations_oapg(
        self,
...
class SearchEntitiesKnowledgeRecommendations(BaseApi):
    ...
    def search_entities_knowledge_recommendations(
        ...
        return self._search_entities_knowledge_recommendations_oapg(
            body=body,
