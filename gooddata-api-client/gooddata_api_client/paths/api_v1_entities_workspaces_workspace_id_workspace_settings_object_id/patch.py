...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiWorkspaceSettingPatchDocument


request_body_json_api_workspace_setting_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiWorkspaceSettingOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_workspace_settings_oapg(
        self,
    ...
    def _patch_entity_workspace_settings_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_workspace_setting_patch_document.serialize(body, content_type)
...
class PatchEntityWorkspaceSettings(BaseApi):
    ...
    def patch_entity_workspace_settings(
        ...
        return self._patch_entity_workspace_settings_oapg(
            body=body,
