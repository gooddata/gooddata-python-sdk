...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiEntitlementOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_entity_entitlements_oapg(
        self,
...
class GetEntityEntitlements(BaseApi):
    ...
    def get_entity_entitlements(
        ...
        return self._get_entity_entitlements_oapg(
