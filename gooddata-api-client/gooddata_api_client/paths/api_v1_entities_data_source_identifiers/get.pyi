...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiDataSourceIdentifierOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_data_source_identifiers_oapg(
        self,
...
class GetAllEntitiesDataSourceIdentifiers(BaseApi):
    ...
    def get_all_entities_data_source_identifiers(
        ...
        return self._get_all_entities_data_source_identifiers_oapg(
