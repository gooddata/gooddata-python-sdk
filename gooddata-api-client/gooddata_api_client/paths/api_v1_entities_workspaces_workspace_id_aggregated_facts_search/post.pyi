...
SchemaFor200ResponseBodyApplicationJson = JsonApiAggregatedFactOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiAggregatedFactOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_aggregated_facts_oapg(
        self,
...
class SearchEntitiesAggregatedFacts(BaseApi):
    ...
    def search_entities_aggregated_facts(
        ...
        return self._search_entities_aggregated_facts_oapg(
            body=body,
