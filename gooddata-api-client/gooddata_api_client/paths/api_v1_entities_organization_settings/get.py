...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiOrganizationSettingOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_organization_settings_oapg(
        self,
...
class GetAllEntitiesOrganizationSettings(BaseApi):
    ...
    def get_all_entities_organization_settings(
        ...
        return self._get_all_entities_organization_settings_oapg(
