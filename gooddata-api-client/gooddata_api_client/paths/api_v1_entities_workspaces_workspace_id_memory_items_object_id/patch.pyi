...
# body param
SchemaForRequestBodyApplicationJson = JsonApiMemoryItemPatchDocument
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiMemoryItemPatchDocument


request_body_json_api_memory_item_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JsonApiMemoryItemOutDocument
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiMemoryItemOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_memory_items_oapg(
        self,
    ...
    def _patch_entity_memory_items_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_memory_item_patch_document.serialize(body, content_type)
...
class PatchEntityMemoryItems(BaseApi):
    ...
    def patch_entity_memory_items(
        ...
        return self._patch_entity_memory_items_oapg(
            body=body,
