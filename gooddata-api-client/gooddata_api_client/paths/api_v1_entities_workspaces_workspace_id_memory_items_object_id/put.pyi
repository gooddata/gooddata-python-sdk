...
# body param
SchemaForRequestBodyApplicationJson = JsonApiMemoryItemInDocument
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiMemoryItemInDocument


request_body_json_api_memory_item_in_document = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_entity_memory_items_oapg(
        self,
    ...
    def _update_entity_memory_items_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_memory_item_in_document.serialize(body, content_type)
...
class UpdateEntityMemoryItems(BaseApi):
    ...
    def update_entity_memory_items(
        ...
        return self._update_entity_memory_items_oapg(
            body=body,
