...
SchemaFor200ResponseBodyApplicationJson = WorkspaceUserGroups
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_workspace_user_groups_oapg(
        self,
...
class ListWorkspaceUserGroups(BaseApi):
    ...
    def list_workspace_user_groups(
        ...
        return self._list_workspace_user_groups_oapg(
