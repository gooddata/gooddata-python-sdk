...
SchemaFor200ResponseBodyApplicationJson = GetQualityIssuesResponse
...
class GetQualityIssues(BaseApi):
    ...
    def get_quality_issues(
        ...
        return self._get_quality_issues_oapg(
