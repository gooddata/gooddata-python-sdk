...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiVisualizationObjectPatchDocument


request_body_json_api_visualization_object_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiVisualizationObjectOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_visualization_objects_oapg(
        self,
    ...
    def _patch_entity_visualization_objects_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_visualization_object_patch_document.serialize(body, content_type)
...
class PatchEntityVisualizationObjects(BaseApi):
    ...
    def patch_entity_visualization_objects(
        ...
        return self._patch_entity_visualization_objects_oapg(
            body=body,
