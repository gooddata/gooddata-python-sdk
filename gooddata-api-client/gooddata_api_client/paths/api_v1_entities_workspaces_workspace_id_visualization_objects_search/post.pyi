...
SchemaFor200ResponseBodyApplicationJson = JsonApiVisualizationObjectOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiVisualizationObjectOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_visualization_objects_oapg(
        self,
...
class SearchEntitiesVisualizationObjects(BaseApi):
    ...
    def search_entities_visualization_objects(
        ...
        return self._search_entities_visualization_objects_oapg(
            body=body,
