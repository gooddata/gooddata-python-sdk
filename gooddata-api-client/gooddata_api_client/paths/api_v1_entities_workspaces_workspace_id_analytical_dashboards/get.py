...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiAnalyticalDashboardOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_analytical_dashboards_oapg(
        self,
...
class GetAllEntitiesAnalyticalDashboards(BaseApi):
    ...
    def get_all_entities_analytical_dashboards(
        ...
        return self._get_all_entities_analytical_dashboards_oapg(
