...
# body param
SchemaForRequestBodyApplicationXml = Xliff


request_body_xliff = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _set_translations_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_xliff.serialize(body, content_type)
...
class SetTranslations(BaseApi):
    ...
    def set_translations(
        ...
        return self._set_translations_oapg(
            body=body,
