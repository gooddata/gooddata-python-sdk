...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiDataSourceOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_data_sources_oapg(
        self,
...
class GetAllEntitiesDataSources(BaseApi):
    ...
    def get_all_entities_data_sources(
        ...
        return self._get_all_entities_data_sources_oapg(
