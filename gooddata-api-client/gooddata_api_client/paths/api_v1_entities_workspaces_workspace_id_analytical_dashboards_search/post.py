...
SchemaFor200ResponseBodyApplicationJson = JsonApiAnalyticalDashboardOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_analytical_dashboards_oapg(
        self,
...
class SearchEntitiesAnalyticalDashboards(BaseApi):
    ...
    def search_entities_analytical_dashboards(
        ...
        return self._search_entities_analytical_dashboards_oapg(
            body=body,
