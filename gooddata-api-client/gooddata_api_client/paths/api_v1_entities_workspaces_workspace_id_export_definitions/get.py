...
SchemaFor200ResponseBodyApplicationJson = JsonApiExportDefinitionOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiExportDefinitionOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_export_definitions_oapg(
        self,
...
class GetAllEntitiesExportDefinitions(BaseApi):
    ...
    def get_all_entities_export_definitions(
        ...
        return self._get_all_entities_export_definitions_oapg(
