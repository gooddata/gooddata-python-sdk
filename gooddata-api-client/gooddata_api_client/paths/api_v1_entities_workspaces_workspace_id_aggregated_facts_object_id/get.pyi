...
SchemaFor200ResponseBodyApplicationJson = JsonApiAggregatedFactOutDocument
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiAggregatedFactOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_entity_aggregated_facts_oapg(
        self,
...
class GetEntityAggregatedFacts(BaseApi):
    ...
    def get_entity_aggregated_facts(
        ...
        return self._get_entity_aggregated_facts_oapg(
