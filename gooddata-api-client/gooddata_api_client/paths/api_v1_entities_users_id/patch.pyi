...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiUserPatchDocument


request_body_json_api_user_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiUserOutDocument
...
class BaseApi(api_client.Api):
    ...
    def _patch_entity_users_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_user_patch_document.serialize(body, content_type)
...
class PatchEntityUsers(BaseApi):
    ...
    def patch_entity_users(
        ...
        return self._patch_entity_users_oapg(
            body=body,
