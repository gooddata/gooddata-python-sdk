...
# body param
SchemaForRequestBodyApplicationJson = DeclarativeAnalytics


request_body_declarative_analytics = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _set_analytics_model_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_declarative_analytics.serialize(body, content_type)
...
class SetAnalyticsModel(BaseApi):
    ...
    def set_analytics_model(
        ...
        return self._set_analytics_model_oapg(
            body=body,
