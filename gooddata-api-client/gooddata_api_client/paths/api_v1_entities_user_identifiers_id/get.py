...
SchemaFor200ResponseBodyApplicationJson = JsonApiUserIdentifierOutDocument
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiUserIdentifierOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_entity_user_identifiers_oapg(
        self,
...
class GetEntityUserIdentifiers(BaseApi):
    ...
    def get_entity_user_identifiers(
        ...
        return self._get_entity_user_identifiers_oapg(
