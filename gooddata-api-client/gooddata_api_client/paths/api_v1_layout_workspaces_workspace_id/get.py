...
SchemaFor200ResponseBodyApplicationJson = DeclarativeWorkspaceModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_workspace_layout_oapg(
        self,
...
class GetWorkspaceLayout(BaseApi):
    ...
    def get_workspace_layout(
        ...
        return self._get_workspace_layout_oapg(
