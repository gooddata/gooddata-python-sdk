...
# body param
SchemaForRequestBodyApplicationJson = DeclarativeWorkspaceModel


request_body_declarative_workspace_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _put_workspace_layout_oapg(
        self,
    ...
    def _put_workspace_layout_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_declarative_workspace_model.serialize(body, content_type)
...
class PutWorkspaceLayout(BaseApi):
    ...
    def put_workspace_layout(
        ...
        return self._put_workspace_layout_oapg(
            body=body,
