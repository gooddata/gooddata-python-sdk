...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiMetricPostOptionalIdDocument


request_body_json_api_metric_post_optional_id_document = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndGooddataApijson = JsonApiMetricOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_entity_metrics_oapg(
        self,
    ...
    def _create_entity_metrics_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_metric_post_optional_id_document.serialize(body, content_type)
...
class CreateEntityMetrics(BaseApi):
    ...
    def create_entity_metrics(
        ...
        return self._create_entity_metrics_oapg(
            body=body,
