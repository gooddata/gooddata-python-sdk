...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiDataSourceIdentifierOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_entity_data_source_identifiers_oapg(
        self,
...
class GetEntityDataSourceIdentifiers(BaseApi):
    ...
    def get_entity_data_source_identifiers(
        ...
        return self._get_entity_data_source_identifiers_oapg(
