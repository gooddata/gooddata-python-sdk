...
# body param
SchemaForRequestBodyApplicationJson = LocaleRequest


request_body_locale_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationXml = Xliff
...
class BaseApi(api_client.Api):
    @typing.overload
    def _retrieve_translations_oapg(
        self,
    ...
    def _retrieve_translations_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_locale_request.serialize(body, content_type)
...
class RetrieveTranslations(BaseApi):
    ...
    def retrieve_translations(
        ...
        return self._retrieve_translations_oapg(
            body=body,
