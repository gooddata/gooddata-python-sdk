...
# body param
SchemaForRequestBodyApplicationJson = ImageExportRequest


request_body_image_export_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_image_export_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_image_export_request.serialize(body, content_type)
...
class CreateImageExport(BaseApi):
    ...
    def create_image_export(
        ...
        return self._create_image_export_oapg(
            body=body,
