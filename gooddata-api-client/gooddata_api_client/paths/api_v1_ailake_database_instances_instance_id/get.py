...
SchemaFor200ResponseBodyApplicationJson = DatabaseInstance
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_ai_lake_database_instance_oapg(
        self,
...
class GetAiLakeDatabaseInstance(BaseApi):
    ...
    def get_ai_lake_database_instance(
        ...
        return self._get_ai_lake_database_instance_oapg(
