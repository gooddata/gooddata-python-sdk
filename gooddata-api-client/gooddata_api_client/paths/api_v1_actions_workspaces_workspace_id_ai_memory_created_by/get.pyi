...
SchemaFor200ResponseBodyApplicationJson = MemoryItemCreatedByUsers
...
class BaseApi(api_client.Api):
    @typing.overload
    def _memory_created_by_users_oapg(
        self,
...
class MemoryCreatedByUsers(BaseApi):
    ...
    def memory_created_by_users(
        ...
        return self._memory_created_by_users_oapg(
