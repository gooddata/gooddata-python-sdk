...
# body param
SchemaForRequestBodyApplicationJson = EntitySearchBody


request_body_entity_search_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JsonApiWorkspaceDataFilterSettingOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiWorkspaceDataFilterSettingOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_workspace_data_filter_settings_oapg(
        self,
    ...
    def _search_entities_workspace_data_filter_settings_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_entity_search_body.serialize(body, content_type)
...
class SearchEntitiesWorkspaceDataFilterSettings(BaseApi):
    ...
    def search_entities_workspace_data_filter_settings(
        ...
        return self._search_entities_workspace_data_filter_settings_oapg(
            body=body,
