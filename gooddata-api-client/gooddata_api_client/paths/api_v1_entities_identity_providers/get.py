...
SchemaFor200ResponseBodyApplicationJson = JsonApiIdentityProviderOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiIdentityProviderOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_identity_providers_oapg(
        self,
...
class GetAllEntitiesIdentityProviders(BaseApi):
    ...
    def get_all_entities_identity_providers(
        ...
        return self._get_all_entities_identity_providers_oapg(
