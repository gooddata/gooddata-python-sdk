...
SchemaFor200ResponseBodyApplicationJson = DeclarativeWorkspaceDataFilters
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_workspace_data_filters_layout_oapg(
        self,
...
class GetWorkspaceDataFiltersLayout(BaseApi):
    ...
    def get_workspace_data_filters_layout(
        ...
        return self._get_workspace_data_filters_layout_oapg(
