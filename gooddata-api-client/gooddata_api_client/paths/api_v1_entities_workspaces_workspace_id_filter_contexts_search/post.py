...
SchemaFor200ResponseBodyApplicationJson = JsonApiFilterContextOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiFilterContextOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_filter_contexts_oapg(
        self,
...
class SearchEntitiesFilterContexts(BaseApi):
    ...
    def search_entities_filter_contexts(
        ...
        return self._search_entities_filter_contexts_oapg(
            body=body,
