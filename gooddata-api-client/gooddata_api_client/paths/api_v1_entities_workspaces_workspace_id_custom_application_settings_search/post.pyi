...
SchemaFor200ResponseBodyApplicationJson = JsonApiCustomApplicationSettingOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiCustomApplicationSettingOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_custom_application_settings_oapg(
        self,
...
class SearchEntitiesCustomApplicationSettings(BaseApi):
    ...
    def search_entities_custom_application_settings(
        ...
        return self._search_entities_custom_application_settings_oapg(
            body=body,
