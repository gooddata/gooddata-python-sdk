...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_workspace_data_filters_oapg(
        self,
...
class GetAllEntitiesWorkspaceDataFilters(BaseApi):
    ...
    def get_all_entities_workspace_data_filters(
        ...
        return self._get_all_entities_workspace_data_filters_oapg(
