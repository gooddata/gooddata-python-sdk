...
class IncludeSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    "workspaceDataFilterSettings": "WORKSPACE_DATA_FILTER_SETTINGS",
...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiWorkspaceDataFilterInDocument


request_body_json_api_workspace_data_filter_in_document = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndGooddataApijson = JsonApiWorkspaceDataFilterOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_entity_workspace_data_filters_oapg(
        self,
    ...
    def _create_entity_workspace_data_filters_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_workspace_data_filter_in_document.serialize(body, content_type)
...
class CreateEntityWorkspaceDataFilters(BaseApi):
    ...
    def create_entity_workspace_data_filters(
        ...
        return self._create_entity_workspace_data_filters_oapg(
            body=body,
