...
# body param
SchemaForRequestBodyApplicationJson = JsonApiFactPatchDocument
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiFactPatchDocument


request_body_json_api_fact_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JsonApiFactOutDocument
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiFactOutDocument
...
class BaseApi(api_client.Api):
    ...
    def _patch_entity_facts_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_fact_patch_document.serialize(body, content_type)
...
class PatchEntityFacts(BaseApi):
    ...
    def patch_entity_facts(
        ...
        return self._patch_entity_facts_oapg(
            body=body,
