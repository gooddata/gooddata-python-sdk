...
SchemaFor200ResponseBodyApplicationJson = JsonApiNotificationChannelOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiNotificationChannelOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_notification_channels_oapg(
        self,
...
class GetAllEntitiesNotificationChannels(BaseApi):
    ...
    def get_all_entities_notification_channels(
        ...
        return self._get_all_entities_notification_channels_oapg(
