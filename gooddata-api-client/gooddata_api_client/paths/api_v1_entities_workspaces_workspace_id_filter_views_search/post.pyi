...
SchemaFor200ResponseBodyApplicationJson = JsonApiFilterViewOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiFilterViewOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_filter_views_oapg(
        self,
...
class SearchEntitiesFilterViews(BaseApi):
    ...
    def search_entities_filter_views(
        ...
        return self._search_entities_filter_views_oapg(
            body=body,
