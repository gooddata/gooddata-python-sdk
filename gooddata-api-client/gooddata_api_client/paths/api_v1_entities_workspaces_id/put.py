...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiWorkspaceOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_entity_workspaces_oapg(
        self,
...
class UpdateEntityWorkspaces(BaseApi):
    ...
    def update_entity_workspaces(
        ...
        return self._update_entity_workspaces_oapg(
            body=body,
