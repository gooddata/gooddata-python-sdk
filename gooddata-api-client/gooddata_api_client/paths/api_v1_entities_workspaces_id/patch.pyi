...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiWorkspacePatchDocument


request_body_json_api_workspace_patch_document = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_workspaces_oapg(
        self,
    ...
    def _patch_entity_workspaces_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_workspace_patch_document.serialize(body, content_type)
...
class PatchEntityWorkspaces(BaseApi):
    ...
    def patch_entity_workspaces(
        ...
        return self._patch_entity_workspaces_oapg(
            body=body,
