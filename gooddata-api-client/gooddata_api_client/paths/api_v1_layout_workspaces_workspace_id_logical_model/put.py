...
# body param
SchemaForRequestBodyApplicationJson = DeclarativeModel


request_body_declarative_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _set_logical_model_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_declarative_model.serialize(body, content_type)
...
class SetLogicalModel(BaseApi):
    ...
    def set_logical_model(
        ...
        return self._set_logical_model_oapg(
            body=body,
