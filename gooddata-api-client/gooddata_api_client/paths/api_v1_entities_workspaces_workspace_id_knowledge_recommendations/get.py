...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_knowledge_recommendations_oapg(
        self,
...
class GetAllEntitiesKnowledgeRecommendations(BaseApi):
    ...
    def get_all_entities_knowledge_recommendations(
        ...
        return self._get_all_entities_knowledge_recommendations_oapg(
