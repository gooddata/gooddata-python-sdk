...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiDashboardPluginInDocument


request_body_json_api_dashboard_plugin_in_document = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_entity_dashboard_plugins_oapg(
        self,
    ...
    def _update_entity_dashboard_plugins_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_dashboard_plugin_in_document.serialize(body, content_type)
...
class UpdateEntityDashboardPlugins(BaseApi):
    ...
    def update_entity_dashboard_plugins(
        ...
        return self._update_entity_dashboard_plugins_oapg(
            body=body,
