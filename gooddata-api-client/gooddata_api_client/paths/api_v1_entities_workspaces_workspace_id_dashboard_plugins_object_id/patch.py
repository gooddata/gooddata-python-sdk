...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiDashboardPluginPatchDocument


request_body_json_api_dashboard_plugin_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiDashboardPluginOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_dashboard_plugins_oapg(
        self,
    ...
    def _patch_entity_dashboard_plugins_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_dashboard_plugin_patch_document.serialize(body, content_type)
...
class PatchEntityDashboardPlugins(BaseApi):
    ...
    def patch_entity_dashboard_plugins(
        ...
        return self._patch_entity_dashboard_plugins_oapg(
            body=body,
