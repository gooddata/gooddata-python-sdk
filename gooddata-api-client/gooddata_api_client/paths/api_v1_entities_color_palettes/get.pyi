...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiColorPaletteOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_color_palettes_oapg(
        self,
...
class GetAllEntitiesColorPalettes(BaseApi):
    ...
    def get_all_entities_color_palettes(
        ...
        return self._get_all_entities_color_palettes_oapg(
