...
SchemaFor200ResponseBodyApplicationJson = JsonApiLabelOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiLabelOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_labels_oapg(
        self,
...
class SearchEntitiesLabels(BaseApi):
    ...
    def search_entities_labels(
        ...
        return self._search_entities_labels_oapg(
            body=body,
