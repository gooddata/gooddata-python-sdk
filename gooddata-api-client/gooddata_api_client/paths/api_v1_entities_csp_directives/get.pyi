...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiCspDirectiveOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_csp_directives_oapg(
        self,
...
class GetAllEntitiesCspDirectives(BaseApi):
    ...
    def get_all_entities_csp_directives(
        ...
        return self._get_all_entities_csp_directives_oapg(
