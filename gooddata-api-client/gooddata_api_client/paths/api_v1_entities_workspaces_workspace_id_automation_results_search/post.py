...
SchemaFor200ResponseBodyApplicationJson = JsonApiAutomationResultOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiAutomationResultOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_automation_results_oapg(
        self,
...
class SearchEntitiesAutomationResults(BaseApi):
    ...
    def search_entities_automation_results(
        ...
        return self._search_entities_automation_results_oapg(
            body=body,
