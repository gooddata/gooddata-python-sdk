...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiWorkspaceOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_workspaces_oapg(
        self,
...
class GetAllEntitiesWorkspaces(BaseApi):
    ...
    def get_all_entities_workspaces(
        ...
        return self._get_all_entities_workspaces_oapg(
