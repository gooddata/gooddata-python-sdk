...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiWorkspaceSettingPostOptionalIdDocument


request_body_json_api_workspace_setting_post_optional_id_document = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndGooddataApijson = JsonApiWorkspaceSettingOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_entity_workspace_settings_oapg(
        self,
    ...
    def _create_entity_workspace_settings_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_workspace_setting_post_optional_id_document.serialize(body, content_type)
...
class CreateEntityWorkspaceSettings(BaseApi):
    ...
    def create_entity_workspace_settings(
        ...
        return self._create_entity_workspace_settings_oapg(
            body=body,
