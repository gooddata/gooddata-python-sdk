...
SchemaFor200ResponseBodyApplicationJson = JsonApiAutomationOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiAutomationOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_automations_oapg(
        self,
...
class GetAllEntitiesAutomations(BaseApi):
    ...
    def get_all_entities_automations(
        ...
        return self._get_all_entities_automations_oapg(
