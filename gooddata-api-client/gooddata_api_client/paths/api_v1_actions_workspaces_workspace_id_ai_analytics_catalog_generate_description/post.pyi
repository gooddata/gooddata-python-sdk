...
# body param
SchemaForRequestBodyApplicationJson = GenerateDescriptionRequest


request_body_generate_description_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GenerateDescriptionResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _generate_description_oapg(
        self,
    ...
    def _generate_description_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_generate_description_request.serialize(body, content_type)
...
class GenerateDescription(BaseApi):
    ...
    def generate_description(
        ...
        return self._generate_description_oapg(
            body=body,
