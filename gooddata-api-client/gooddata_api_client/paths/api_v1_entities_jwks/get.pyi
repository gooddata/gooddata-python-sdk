...
SchemaFor200ResponseBodyApplicationJson = JsonApiJwkOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiJwkOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_jwks_oapg(
        self,
...
class GetAllEntitiesJwks(BaseApi):
    ...
    def get_all_entities_jwks(
        ...
        return self._get_all_entities_jwks_oapg(
