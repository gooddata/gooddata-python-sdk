...
SchemaFor200ResponseBodyApplicationJson = JsonApiAttributeOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiAttributeOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_attributes_oapg(
        self,
...
class SearchEntitiesAttributes(BaseApi):
    ...
    def search_entities_attributes(
        ...
        return self._search_entities_attributes_oapg(
            body=body,
