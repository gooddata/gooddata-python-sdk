...
SchemaFor200ResponseBodyApplicationJson = JsonApiUserIdentifierOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiUserIdentifierOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_user_identifiers_oapg(
        self,
...
class GetAllEntitiesUserIdentifiers(BaseApi):
    ...
    def get_all_entities_user_identifiers(
        ...
        return self._get_all_entities_user_identifiers_oapg(
