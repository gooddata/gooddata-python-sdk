...
SchemaFor200ResponseBodyApplicationJson = JsonApiNotificationChannelIdentifierOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiNotificationChannelIdentifierOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_notification_channel_identifiers_oapg(
        self,
...
class GetAllEntitiesNotificationChannelIdentifiers(BaseApi):
    ...
    def get_all_entities_notification_channel_identifiers(
        ...
        return self._get_all_entities_notification_channel_identifiers_oapg(
