...
SchemaFor200ResponseBodyApplicationJson = JsonApiWorkspaceDataFilterOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiWorkspaceDataFilterOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_workspace_data_filters_oapg(
        self,
...
class SearchEntitiesWorkspaceDataFilters(BaseApi):
    ...
    def search_entities_workspace_data_filters(
        ...
        return self._search_entities_workspace_data_filters_oapg(
            body=body,
