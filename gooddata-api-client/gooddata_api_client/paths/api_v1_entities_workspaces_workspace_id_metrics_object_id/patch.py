...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiMetricPatchDocument


request_body_json_api_metric_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiMetricOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_metrics_oapg(
        self,
    ...
    def _patch_entity_metrics_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_metric_patch_document.serialize(body, content_type)
...
class PatchEntityMetrics(BaseApi):
    ...
    def patch_entity_metrics(
        ...
        return self._patch_entity_metrics_oapg(
            body=body,
