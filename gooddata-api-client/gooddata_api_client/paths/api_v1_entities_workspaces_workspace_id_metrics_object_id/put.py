...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiMetricInDocument


request_body_json_api_metric_in_document = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_entity_metrics_oapg(
        self,
    ...
    def _update_entity_metrics_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_metric_in_document.serialize(body, content_type)
...
class UpdateEntityMetrics(BaseApi):
    ...
    def update_entity_metrics(
        ...
        return self._update_entity_metrics_oapg(
            body=body,
