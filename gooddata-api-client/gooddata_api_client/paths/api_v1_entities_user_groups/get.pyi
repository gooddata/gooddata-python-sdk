...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiUserGroupOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_user_groups_oapg(
        self,
...
class GetAllEntitiesUserGroups(BaseApi):
    ...
    def get_all_entities_user_groups(
        ...
        return self._get_all_entities_user_groups_oapg(
