...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiCustomApplicationSettingPatchDocument


request_body_json_api_custom_application_setting_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiCustomApplicationSettingOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_custom_application_settings_oapg(
        self,
    ...
    def _patch_entity_custom_application_settings_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_custom_application_setting_patch_document.serialize(body, content_type)
...
class PatchEntityCustomApplicationSettings(BaseApi):
    ...
    def patch_entity_custom_application_settings(
        ...
        return self._patch_entity_custom_application_settings_oapg(
            body=body,
