...
# body param
SchemaForRequestBodyApplicationJson = PatchKnowledgeDocumentRequestDto


request_body_patch_knowledge_document_request_dto = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = KnowledgeDocumentMetadataDto
...
class BaseApi(api_client.Api):
    ...
    def _patch_document_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_knowledge_document_request_dto.serialize(body, content_type)
...
class PatchDocument(BaseApi):
    ...
    def patch_document(
        ...
        return self._patch_document_oapg(
            body=body,
