...
# body param
SchemaForRequestBodyApplicationJson = JsonApiFilterViewPatchDocument
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiFilterViewPatchDocument


request_body_json_api_filter_view_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JsonApiFilterViewOutDocument
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiFilterViewOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_filter_views_oapg(
        self,
    ...
    def _patch_entity_filter_views_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_filter_view_patch_document.serialize(body, content_type)
...
class PatchEntityFilterViews(BaseApi):
    ...
    def patch_entity_filter_views(
        ...
        return self._patch_entity_filter_views_oapg(
            body=body,
