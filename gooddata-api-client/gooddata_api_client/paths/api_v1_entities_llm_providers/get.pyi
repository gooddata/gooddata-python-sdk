...
SchemaFor200ResponseBodyApplicationJson = JsonApiLlmProviderOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiLlmProviderOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_llm_providers_oapg(
        self,
...
class GetAllEntitiesLlmProviders(BaseApi):
    ...
    def get_all_entities_llm_providers(
        ...
        return self._get_all_entities_llm_providers_oapg(
