...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiApiTokenOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_api_tokens_oapg(
        self,
...
class GetAllEntitiesApiTokens(BaseApi):
    ...
    def get_all_entities_api_tokens(
        ...
        return self._get_all_entities_api_tokens_oapg(
