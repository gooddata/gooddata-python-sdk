...
SchemaFor200ResponseBodyApplicationJson = ResolvedLlmEndpoints
...
class BaseApi(api_client.Api):
    @typing.overload
    def _resolve_llm_endpoints_oapg(
        self,
...
class ResolveLlmEndpoints(BaseApi):
    ...
    def resolve_llm_endpoints(
        ...
        return self._resolve_llm_endpoints_oapg(
