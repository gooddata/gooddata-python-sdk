...
# body param
SchemaForRequestBodyApplicationJson = DependentEntitiesRequest


request_body_dependent_entities_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = DependentEntitiesResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_dependent_entities_graph_from_entry_points_oapg(
        self,
    ...
    def _get_dependent_entities_graph_from_entry_points_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_dependent_entities_request.serialize(body, content_type)
...
class GetDependentEntitiesGraphFromEntryPoints(BaseApi):
    ...
    def get_dependent_entities_graph_from_entry_points(
        ...
        return self._get_dependent_entities_graph_from_entry_points_oapg(
            body=body,
