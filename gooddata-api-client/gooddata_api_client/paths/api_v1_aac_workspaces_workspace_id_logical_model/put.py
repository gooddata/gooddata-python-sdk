...
# body param
SchemaForRequestBodyApplicationJson = AacLogicalModel


request_body_aac_logical_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _set_logical_model_aac_oapg(
        self,
    ...
    def _set_logical_model_aac_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_aac_logical_model.serialize(body, content_type)
...
class SetLogicalModelAac(BaseApi):
    ...
    def set_logical_model_aac(
        ...
        return self._set_logical_model_aac_oapg(
            body=body,
