...
# body param
SchemaForRequestBodyApplicationJson = JsonApiKnowledgeRecommendationPatchDocument
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiKnowledgeRecommendationPatchDocument


request_body_json_api_knowledge_recommendation_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JsonApiKnowledgeRecommendationOutDocument
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiKnowledgeRecommendationOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_knowledge_recommendations_oapg(
        self,
    ...
    def _patch_entity_knowledge_recommendations_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_knowledge_recommendation_patch_document.serialize(body, content_type)
...
class PatchEntityKnowledgeRecommendations(BaseApi):
    ...
    def patch_entity_knowledge_recommendations(
        ...
        return self._patch_entity_knowledge_recommendations_oapg(
            body=body,
