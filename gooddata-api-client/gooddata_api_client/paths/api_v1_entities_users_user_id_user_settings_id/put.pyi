...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiUserSettingOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_entity_user_settings_oapg(
        self,
...
class UpdateEntityUserSettings(BaseApi):
    ...
    def update_entity_user_settings(
        ...
        return self._update_entity_user_settings_oapg(
            body=body,
