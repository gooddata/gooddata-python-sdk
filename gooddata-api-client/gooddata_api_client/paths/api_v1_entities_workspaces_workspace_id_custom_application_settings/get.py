...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_all_entities_custom_application_settings_oapg(
        self,
...
class GetAllEntitiesCustomApplicationSettings(BaseApi):
    ...
    def get_all_entities_custom_application_settings(
        ...
        return self._get_all_entities_custom_application_settings_oapg(
