...
SchemaFor200ResponseBodyApplicationJson = DeclarativeUsersUserGroups
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_users_user_groups_layout_oapg(
        self,
...
class GetUsersUserGroupsLayout(BaseApi):
    ...
    def get_users_user_groups_layout(
        ...
        return self._get_users_user_groups_layout_oapg(
