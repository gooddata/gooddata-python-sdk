...
SchemaFor200ResponseBodyApplicationJson = AnomalyDetectionResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _anomaly_detection_result_oapg(
        self,
...
class AnomalyDetectionResult(BaseApi):
    ...
    def anomaly_detection_result(
        ...
        return self._anomaly_detection_result_oapg(
