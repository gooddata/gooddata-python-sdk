...
request_body_entitlements_request = api_client.RequestBody(
    content={
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ApiEntitlement'], typing.List['ApiEntitlement']],
    ...
    def __getitem__(self, i: int) -> 'ApiEntitlement':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _resolve_requested_entitlements_oapg(
        self,
    ...
    def _resolve_requested_entitlements_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_entitlements_request.serialize(body, content_type)
...
class ResolveRequestedEntitlements(BaseApi):
    ...
    def resolve_requested_entitlements(
        ...
        return self._resolve_requested_entitlements_oapg(
            body=body,
