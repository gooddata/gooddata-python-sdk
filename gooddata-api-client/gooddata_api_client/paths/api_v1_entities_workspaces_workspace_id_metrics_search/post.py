...
SchemaFor200ResponseBodyApplicationJson = JsonApiMetricOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiMetricOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_metrics_oapg(
        self,
...
class SearchEntitiesMetrics(BaseApi):
    ...
    def search_entities_metrics(
        ...
        return self._search_entities_metrics_oapg(
            body=body,
