...
SchemaFor200ResponseBodyApplicationJson = JsonApiDashboardPluginOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiDashboardPluginOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_dashboard_plugins_oapg(
        self,
...
class SearchEntitiesDashboardPlugins(BaseApi):
    ...
    def search_entities_dashboard_plugins(
        ...
        return self._search_entities_dashboard_plugins_oapg(
            body=body,
