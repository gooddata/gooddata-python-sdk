...
# body param
SchemaForRequestBodyApplicationJson = JsonApiAttributeHierarchyPatchDocument
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiAttributeHierarchyPatchDocument


request_body_json_api_attribute_hierarchy_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = JsonApiAttributeHierarchyOutDocument
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiAttributeHierarchyOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_attribute_hierarchies_oapg(
        self,
    ...
    def _patch_entity_attribute_hierarchies_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_attribute_hierarchy_patch_document.serialize(body, content_type)
...
class PatchEntityAttributeHierarchies(BaseApi):
    ...
    def patch_entity_attribute_hierarchies(
        ...
        return self._patch_entity_attribute_hierarchies_oapg(
            body=body,
