...
# body param
SchemaForRequestBodyApplicationJson = RawExportRequest


request_body_raw_export_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_raw_export_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_raw_export_request.serialize(body, content_type)
...
class CreateRawExport(BaseApi):
    ...
    def create_raw_export(
        ...
        return self._create_raw_export_oapg(
            body=body,
