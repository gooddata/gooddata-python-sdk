...
SchemaFor200ResponseBodyApplicationJson = JsonApiWorkspaceSettingOutList
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiWorkspaceSettingOutList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _search_entities_workspace_settings_oapg(
        self,
...
class SearchEntitiesWorkspaceSettings(BaseApi):
    ...
    def search_entities_workspace_settings(
        ...
        return self._search_entities_workspace_settings_oapg(
            body=body,
