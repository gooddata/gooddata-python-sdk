...
SchemaFor200ResponseBodyApplicationJson = DeclarativeWorkspaces
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_workspaces_layout_oapg(
        self,
...
class GetWorkspacesLayout(BaseApi):
    ...
    def get_workspaces_layout(
        ...
        return self._get_workspaces_layout_oapg(
