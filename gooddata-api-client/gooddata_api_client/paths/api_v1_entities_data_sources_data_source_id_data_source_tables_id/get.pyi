...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiDataSourceTableOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_entity_data_source_tables_oapg(
        self,
...
class GetEntityDataSourceTables(BaseApi):
    ...
    def get_entity_data_source_tables(
        ...
        return self._get_entity_data_source_tables_oapg(
