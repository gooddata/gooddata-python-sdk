...
# body param
SchemaForRequestBodyApplicationVndGooddataApijson = JsonApiWorkspaceDataFilterPatchDocument


request_body_json_api_workspace_data_filter_patch_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndGooddataApijson = JsonApiWorkspaceDataFilterOutDocument
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_entity_workspace_data_filters_oapg(
        self,
    ...
    def _patch_entity_workspace_data_filters_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_json_api_workspace_data_filter_patch_document.serialize(body, content_type)
...
class PatchEntityWorkspaceDataFilters(BaseApi):
    ...
    def patch_entity_workspace_data_filters(
        ...
        return self._patch_entity_workspace_data_filters_oapg(
            body=body,
