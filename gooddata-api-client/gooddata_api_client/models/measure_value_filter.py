...
MEASUREVALUEFILTER_ONE_OF_SCHEMAS = ["ComparisonMeasureValueFilter", "RangeMeasureValueFilter"]
...
class MeasureValueFilter(BaseModel):
    ...
    actual_instance: Optional[Union[ComparisonMeasureValueFilter, RangeMeasureValueFilter]] = None
    one_of_schemas: Set[str] = { "ComparisonMeasureValueFilter", "RangeMeasureValueFilter" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in MeasureValueFilter with oneOf schemas: ComparisonMeasureValueFilter, RangeMeasureValueFilter. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in MeasureValueFilter with oneOf schemas: ComparisonMeasureValueFilter, RangeMeasureValueFilter. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into MeasureValueFilter with oneOf schemas: ComparisonMeasureValueFilter, RangeMeasureValueFilter. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into MeasureValueFilter with oneOf schemas: ComparisonMeasureValueFilter, RangeMeasureValueFilter. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ComparisonMeasureValueFilter, RangeMeasureValueFilter]]:
