...
class JsonApiOrganizationInAttributes(BaseModel):
    ...
    oauth_client_secret: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, alias="oauthClientSecret")
    ...
    __properties: ClassVar[List[str]] = ["allowedOrigins", "earlyAccess", "earlyAccessValues", "hostname", "name", "oauthClientId", "oauthClientSecret", "oauthCustomAuthAttributes", "oauthCustomScopes", "oauthIssuerId", "oauthIssuerLocation", "oauthSubjectIdClaim"]
