...
class RouteResult(BaseModel):
    ...
    def use_case_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['INVALID', 'GENERAL', 'SEARCH', 'CREATE_VISUALIZATION', 'EXTEND_VISUALIZATION', 'HOWTO']):
            raise ValueError("must be one of enum values ('INVALID', 'GENERAL', 'SEARCH', 'CREATE_VISUALIZATION', 'EXTEND_VISUALIZATION', 'HOWTO')")
        return value
