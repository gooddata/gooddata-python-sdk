...
class ChatHistoryInteraction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["chatHistoryInteractionId", "createdVisualizations", "errorResponse", "foundObjects", "interactionFinished", "question", "routing", "textResponse", "threadIdSuffix", "userFeedback"]
