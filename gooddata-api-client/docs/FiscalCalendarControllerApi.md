# gooddata_api_client.FiscalCalendarControllerApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_all_entities_fiscal_calendars**](FiscalCalendarControllerApi.md#get_all_entities_fiscal_calendars) | **GET** /api/v1/entities/workspaces/{workspaceId}/fiscalCalendars | Get all Fiscal Calendars
[**get_entity_fiscal_calendars**](FiscalCalendarControllerApi.md#get_entity_fiscal_calendars) | **GET** /api/v1/entities/workspaces/{workspaceId}/fiscalCalendars/{objectId} | Get a Fiscal Calendar
...
from gooddata_api_client.api import fiscal_calendar_controller_api
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    api_instance = fiscal_calendar_controller_api.FiscalCalendarControllerApi(api_client)
    ...
    try:
        ...
        print("Exception when calling FiscalCalendarControllerApi->get_all_entities_fiscal_calendars: %s\n" % e)
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling FiscalCalendarControllerApi->get_entity_fiscal_calendars: %s\n" % e)
