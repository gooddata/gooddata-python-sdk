...
from gooddata_api_client.api import notification_channel_controller_api
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    api_instance = notification_channel_controller_api.NotificationChannelControllerApi(api_client)
