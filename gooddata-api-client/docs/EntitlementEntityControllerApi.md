...
from gooddata_api_client.api import entitlement_entity_controller_api
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    api_instance = entitlement_entity_controller_api.EntitlementEntityControllerApi(api_client)
