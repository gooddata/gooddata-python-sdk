...
[**register_workspace_upload_notification**](InvalidateCacheApi.md#register_workspace_upload_notification) | **POST** /api/v1/actions/workspaces/{workspaceId}/uploadNotification | Register an upload notification
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling InvalidateCacheApi->register_workspace_upload_notification: %s\n" % e)
```
