...
[**create_entity_widget_alerts**](WorkspaceObjectControllerApi.md#create_entity_widget_alerts) | **POST** /api/v1/entities/workspaces/{workspaceId}/widgetAlerts | Post Widget Alerts
...
[**delete_entity_widget_alerts**](WorkspaceObjectControllerApi.md#delete_entity_widget_alerts) | **DELETE** /api/v1/entities/workspaces/{workspaceId}/widgetAlerts/{objectId} | Delete a Widget Alert
...
[**get_all_entities_widget_alerts**](WorkspaceObjectControllerApi.md#get_all_entities_widget_alerts) | **GET** /api/v1/entities/workspaces/{workspaceId}/widgetAlerts | Get all Widget Alerts
...
[**get_entity_widget_alerts**](WorkspaceObjectControllerApi.md#get_entity_widget_alerts) | **GET** /api/v1/entities/workspaces/{workspaceId}/widgetAlerts/{objectId} | Get a Widget Alert
...
[**patch_entity_widget_alerts**](WorkspaceObjectControllerApi.md#patch_entity_widget_alerts) | **PATCH** /api/v1/entities/workspaces/{workspaceId}/widgetAlerts/{objectId} | Patch a Widget Alert
...
[**update_entity_widget_alerts**](WorkspaceObjectControllerApi.md#update_entity_widget_alerts) | **PUT** /api/v1/entities/workspaces/{workspaceId}/widgetAlerts/{objectId} | Put a Widget Alert
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling WorkspaceObjectControllerApi->create_entity_widget_alerts: %s\n" % e)
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling WorkspaceObjectControllerApi->delete_entity_widget_alerts: %s\n" % e)
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling WorkspaceObjectControllerApi->get_all_entities_widget_alerts: %s\n" % e)
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling WorkspaceObjectControllerApi->get_entity_widget_alerts: %s\n" % e)
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling WorkspaceObjectControllerApi->patch_entity_widget_alerts: %s\n" % e)
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling WorkspaceObjectControllerApi->update_entity_widget_alerts: %s\n" % e)
