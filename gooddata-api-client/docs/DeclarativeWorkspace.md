...
**color_palettes** | [**[DeclarativeWorkspaceColorPalette]**](DeclarativeWorkspaceColorPalette.md) | A list of workspace color palettes. | [optional] 
...
**export_templates** | [**[DeclarativeWorkspaceExportTemplate]**](DeclarativeWorkspaceExportTemplate.md) | A list of workspace export templates. | [optional] 
...
**managed** | **bool** | Whether the workspace is platform-managed and read-only. Informational on export; ignored on import (the flag is server-controlled). | [optional] [readonly] 
...
**themes** | [**[DeclarativeWorkspaceTheme]**](DeclarativeWorkspaceTheme.md) | A list of workspace themes. | [optional] 
