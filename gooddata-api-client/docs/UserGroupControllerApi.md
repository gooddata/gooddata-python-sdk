...
from gooddata_api_client.api import user_group_controller_api
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    api_instance = user_group_controller_api.UserGroupControllerApi(api_client)
    json_api_user_group_in_document = JsonApiUserGroupInDocument(
        data=JsonApiUserGroupIn(
            ...
            relationships=JsonApiUserGroupInRelationships(
                parents=JsonApiAgentInRelationshipsUserGroups(
