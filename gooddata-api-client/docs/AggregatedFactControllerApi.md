...
from gooddata_api_client.api import aggregated_fact_controller_api
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    api_instance = aggregated_fact_controller_api.AggregatedFactControllerApi(api_client)
    ...
    include = [
        "dataset,sourceFact,sourceAttribute",
