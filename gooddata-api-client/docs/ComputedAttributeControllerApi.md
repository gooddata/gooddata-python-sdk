# gooddata_api_client.ComputedAttributeControllerApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_entity_computed_attributes**](ComputedAttributeControllerApi.md#create_entity_computed_attributes) | **POST** /api/v1/entities/workspaces/{workspaceId}/computedAttributes | Post Computed Attributes
[**delete_entity_computed_attributes**](ComputedAttributeControllerApi.md#delete_entity_computed_attributes) | **DELETE** /api/v1/entities/workspaces/{workspaceId}/computedAttributes/{objectId} | Delete a Computed Attribute
[**get_all_entities_computed_attributes**](ComputedAttributeControllerApi.md#get_all_entities_computed_attributes) | **GET** /api/v1/entities/workspaces/{workspaceId}/computedAttributes | Get all Computed Attributes
[**get_entity_computed_attributes**](ComputedAttributeControllerApi.md#get_entity_computed_attributes) | **GET** /api/v1/entities/workspaces/{workspaceId}/computedAttributes/{objectId} | Get a Computed Attribute
[**patch_entity_computed_attributes**](ComputedAttributeControllerApi.md#patch_entity_computed_attributes) | **PATCH** /api/v1/entities/workspaces/{workspaceId}/computedAttributes/{objectId} | Patch a Computed Attribute
[**search_entities_computed_attributes**](ComputedAttributeControllerApi.md#search_entities_computed_attributes) | **POST** /api/v1/entities/workspaces/{workspaceId}/computedAttributes/search | The search endpoint (beta)
[**update_entity_computed_attributes**](ComputedAttributeControllerApi.md#update_entity_computed_attributes) | **PUT** /api/v1/entities/workspaces/{workspaceId}/computedAttributes/{objectId} | Put a Computed Attribute
...
from gooddata_api_client.api import computed_attribute_controller_api
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling ComputedAttributeControllerApi->create_entity_computed_attributes: %s\n" % e)
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling ComputedAttributeControllerApi->delete_entity_computed_attributes: %s\n" % e)
```
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling ComputedAttributeControllerApi->get_all_entities_computed_attributes: %s\n" % e)
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling ComputedAttributeControllerApi->get_entity_computed_attributes: %s\n" % e)
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling ComputedAttributeControllerApi->patch_entity_computed_attributes: %s\n" % e)
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling ComputedAttributeControllerApi->search_entities_computed_attributes: %s\n" % e)
...
with gooddata_api_client.ApiClient() as api_client:
    ...
    try:
        ...
        print("Exception when calling ComputedAttributeControllerApi->update_entity_computed_attributes: %s\n" % e)
