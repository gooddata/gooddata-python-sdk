# gooddata_api_client.model.json_api_identity_provider_out.JsonApiIdentityProviderOut
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | JSON:API representation of identityProvider entity. | 
