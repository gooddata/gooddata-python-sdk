# gooddata_api_client.models.json_api_metric_out.JsonApiMetricOut
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | JSON:API representation of metric entity. | 
...
**type** | str,  | str,  | Object type | must be one of ["metric", ] 
