# gooddata_api_client.model.json_api_export_definition_patch.JsonApiExportDefinitionPatch
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | JSON:API representation of patching exportDefinition entity. | 
