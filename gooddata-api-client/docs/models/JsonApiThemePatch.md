# gooddata_api_client.models.json_api_theme_patch.JsonApiThemePatch
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | JSON:API representation of patching theme entity. | 
...
**type** | str,  | str,  | Object type | must be one of ["theme", ] 
