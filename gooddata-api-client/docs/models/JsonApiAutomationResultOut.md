# gooddata_api_client.model.json_api_automation_result_out.JsonApiAutomationResultOut
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | JSON:API representation of automationResult entity. | 
...
**type** | str,  | str,  | Object type | must be one of ["automationResult", ] 
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**executedAt** | str, datetime,  | str,  | Timestamp of the last automation run. | value must conform to RFC-3339 date-time
**status** | str,  | str,  | Status of the last automation run. | must be one of ["SUCCESS", "FAILED", ] 
