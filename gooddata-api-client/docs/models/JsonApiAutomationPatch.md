# gooddata_api_client.model.json_api_automation_patch.JsonApiAutomationPatch
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | JSON:API representation of patching automation entity. | 
