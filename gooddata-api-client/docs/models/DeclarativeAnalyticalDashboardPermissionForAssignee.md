# gooddata_api_client.model.declarative_analytical_dashboard_permission_for_assignee.DeclarativeAnalyticalDashboardPermissionForAssignee
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Analytical dashboard permission for an assignee. | 
...
------------ | ------------- | ------------- | ------------- | -------------
**assignee** | [**AssigneeIdentifier**](AssigneeIdentifier.md) | [**AssigneeIdentifier**](AssigneeIdentifier.md) |  | [optional] 
