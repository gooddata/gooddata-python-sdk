# gooddata_api_client.model.json_api_llm_endpoint_patch.JsonApiLlmEndpointPatch
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | JSON:API representation of patching llmEndpoint entity. | 
...
**title** | str,  | str,  | User-facing title of the LLM Provider. | [optional] 
**token** | str,  | str,  | The token to use to connect to the LLM provider. | [optional] 
**any_string_name** | dict, frozendict.frozendict, str, date, datetime, int, float, bool, decimal.Decimal, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, BoolClass, decimal.Decimal, NoneClass, tuple, bytes, FileIO | any string name can be used but the value must be the correct type | [optional]
