# gooddata_api_client.model.json_api_user_data_filter_patch.JsonApiUserDataFilterPatch
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | JSON:API representation of patching userDataFilter entity. | 
