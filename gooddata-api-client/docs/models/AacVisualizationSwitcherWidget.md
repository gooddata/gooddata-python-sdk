# gooddata_api_client.model.aac_visualization_switcher_widget.AacVisualizationSwitcherWidget
...
------------ | ------------- | ------------- | ------------- | -------------
**[visualizations](#visualizations)** | list, tuple,  | tuple,  |  | 
...
**content** | str,  | str,  | Rich text content. | [optional] 
...
------------- | ------------- | ------------- | ------------- | -------------
[**AacVisualizationWidget**](AacVisualizationWidget.md) | [**AacVisualizationWidget**](AacVisualizationWidget.md) | [**AacVisualizationWidget**](AacVisualizationWidget.md) |  | 
