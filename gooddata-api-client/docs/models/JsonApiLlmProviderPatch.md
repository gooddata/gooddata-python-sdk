# gooddata_api_client.model.json_api_llm_provider_patch.JsonApiLlmProviderPatch
...
**[models](#models)** | list, tuple, None,  | tuple, NoneClass,  | List of LLM models available for this provider. | [optional] 
