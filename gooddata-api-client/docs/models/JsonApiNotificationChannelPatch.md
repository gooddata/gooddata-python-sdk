# gooddata_api_client.model.json_api_notification_channel_patch.JsonApiNotificationChannelPatch
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | JSON:API representation of patching notificationChannel entity. | 
