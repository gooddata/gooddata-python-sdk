# gooddata_api_client.models.json_api_data_source_patch.JsonApiDataSourcePatch
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | JSON:API representation of patching dataSource entity. | 
...
**type** | str,  | str,  | Object type | must be one of ["dataSource", ] 
...
**type** | str,  | str,  |  | [optional] must be one of ["POSTGRESQL", "REDSHIFT", "VERTICA", "SNOWFLAKE", "ADS", "BIGQUERY", "MSSQL", "PRESTO", "DREMIO", "DRILL", "GREENPLUM", "AZURESQL", "SYNAPSESQL", "DATABRICKS", ] 
