# gooddata_api_client.model.json_api_filter_view_out.JsonApiFilterViewOut
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | JSON:API representation of filterView entity. | 
...
------------ | ------------- | ------------- | ------------- | -------------
**title** | str,  | str,  |  | 
**[content](#content)** | dict, frozendict.frozendict,  | frozendict.frozendict,  | The respective filter context. | 
