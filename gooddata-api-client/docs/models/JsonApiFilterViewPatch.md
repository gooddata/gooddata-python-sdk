# gooddata_api_client.model.json_api_filter_view_patch.JsonApiFilterViewPatch
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | JSON:API representation of patching filterView entity. | 
...
**type** | str,  | str,  | Object type | must be one of ["filterView", ] 
...
**[content](#content)** | dict, frozendict.frozendict,  | frozendict.frozendict,  | The respective filter context. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | The respective filter context. | 
