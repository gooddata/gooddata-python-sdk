# gooddata_api_client.model.dashboard_tabular_export_request_v2.DashboardTabularExportRequestV2
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Export request object describing the export properties for dashboard tabular exports (v2 with dashboardId). | 
