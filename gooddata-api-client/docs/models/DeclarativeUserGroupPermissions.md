# gooddata_api_client.models.declarative_user_group_permissions.DeclarativeUserGroupPermissions
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Definition of permissions associated with a user-group. | 
