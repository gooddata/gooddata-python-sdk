...
class ElementsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'total_count_without_filters': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'paging': 'paging',  # noqa: E501
        'total_count_without_filters': 'totalCountWithoutFilters',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, primary_label, elements, paging, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            total_count_without_filters (int): Total count of items ignoring all filters (using on ```project``` and  ```label``` from request).. [optional]  # noqa: E501
        """
