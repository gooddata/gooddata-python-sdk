...
class Dimension(ModelNormal):
    ...
    def _from_openapi_data(cls, item_identifiers, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            sorting ([dict]): List of sorting rules. From most relevant to least relevant (less relevant rule is applied, when more relevant rule compares items as equal).. [optional]  # noqa: E501
        """
