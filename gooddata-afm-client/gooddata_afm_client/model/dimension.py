...
class Dimension(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'sorting': ([bool, date, datetime, dict, float, int, list, str, none_type],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, item_identifiers, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            sorting ([bool, date, datetime, dict, float, int, list, str, none_type]): List of sorting rules. From most relevant to least relevant (less relevant rule is applied, when more relevant rule compares items as equal).. [optional]  # noqa: E501
        """
