...
class AFM(ModelNormal):
    ...
    def _from_openapi_data(cls, attributes, filters, measures, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            measures ([MeasureItem]): Measures to be computed.
        ...
        Keyword Args:
            ...
            aux_measures ([MeasureItem]): Measures to be referenced from other AFM objects (e.g. filters) but not included in the result.. [optional]  # noqa: E501
        """
