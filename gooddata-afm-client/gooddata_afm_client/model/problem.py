...
class Problem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, trace_id, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            instance (str): An relative URI that identifies the specific occurrence of the problem. It may yield further information if dereferenced.. [optional]  # noqa: E501
            title (str): A short, summary of the problem type. Written in english and readable for engineers (usually not suited for non technical stakeholders and not localized).. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, trace_id, type, *args, **kwargs):  # noqa: E501
        """Problem - a model defined in OpenAPI
