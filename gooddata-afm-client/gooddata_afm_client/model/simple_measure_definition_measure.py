...
class SimpleMeasureDefinitionMeasure(ModelNormal):
    ...
    def _from_openapi_data(cls, item, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            aggregation (str): Definition of aggregation type of the measure.. [optional]  # noqa: E501
            compute_ratio (bool): If true compute the percentage of given measure values (broken down by AFM attributes) to the total (not broken down).. [optional] if omitted the server will use the default value of False  # noqa: E501
            filters ([FilterDefinitionForSimpleMeasure]): Measure can be filtered by attribute filters with the same interface as ones for global AFM. Note that only one DateFilter is allowed.. [optional]  # noqa: E501
        """
