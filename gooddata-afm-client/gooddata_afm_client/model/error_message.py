...
class ErrorMessage(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, timestamp, status, error, message, path, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, timestamp, status, error, message, path, *args, **kwargs):  # noqa: E501
        """ErrorMessage - a model defined in OpenAPI
