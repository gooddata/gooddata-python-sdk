...
class ElementsRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, label, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            data_sampling_percentage (float): Specifies percentage of source table data scanned during the computation.. [optional] if omitted the server will use the default value of 100  # noqa: E501
        """
