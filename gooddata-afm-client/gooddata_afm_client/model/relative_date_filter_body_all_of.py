...
class RelativeDateFilterBodyAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, granularity, _from, to, *args, **kwargs):  # noqa: E501
        """RelativeDateFilterBodyAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, granularity, _from, to, *args, **kwargs):  # noqa: E501
        """RelativeDateFilterBodyAllOf - a model defined in OpenAPI
