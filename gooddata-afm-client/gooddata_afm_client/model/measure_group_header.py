...
class MeasureGroupHeader(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, measure_group_headers, *args, **kwargs):  # noqa: E501
        """MeasureGroupHeader - a model defined in OpenAPI

        Args:
            measure_group_headers ([MeasureHeaderOut]):
        ...
        self.measure_group_headers = measure_group_headers
    ...
    @convert_js_args_to_python_args
    def __init__(self, measure_group_headers, *args, **kwargs):  # noqa: E501
        """MeasureGroupHeader - a model defined in OpenAPI
