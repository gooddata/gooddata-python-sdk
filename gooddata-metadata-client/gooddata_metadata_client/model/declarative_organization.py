...
class DeclarativeOrganization(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, organization, users, user_groups, data_sources, workspaces, workspace_data_filters, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, organization, users, user_groups, data_sources, workspaces, workspace_data_filters, *args, **kwargs):  # noqa: E501
        """DeclarativeOrganization - a model defined in OpenAPI
