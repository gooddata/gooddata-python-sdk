...
class DeclarativeAnalyticsLayer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, analytical_dashboards, filter_contexts, metrics, visualization_objects, *args, **kwargs):  # noqa: E501
        """DeclarativeAnalyticsLayer - a model defined in OpenAPI

        Args:
            analytical_dashboards ([DeclarativeAnalyticalDashboard]): A list of analytical dashboards available in the model.
            filter_contexts ([DeclarativeFilterContext]): A list of filter contexts available in the model.
            metrics ([DeclarativeMetric]): A list of metrics available in the model.
            visualization_objects ([DeclarativeVisualizationObject]): A list of visualization objects available in the model.
        ...
        self.analytical_dashboards = analytical_dashboards
        self.filter_contexts = filter_contexts
        self.metrics = metrics
        self.visualization_objects = visualization_objects
    ...
    @convert_js_args_to_python_args
    def __init__(self, analytical_dashboards, filter_contexts, metrics, visualization_objects, *args, **kwargs):  # noqa: E501
        """DeclarativeAnalyticsLayer - a model defined in OpenAPI
