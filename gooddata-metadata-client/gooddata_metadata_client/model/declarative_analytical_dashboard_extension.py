...
class DeclarativeAnalyticalDashboardExtension(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, permissions, *args, **kwargs):  # noqa: E501
        """DeclarativeAnalyticalDashboardExtension - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, permissions, *args, **kwargs):  # noqa: E501
        """DeclarativeAnalyticalDashboardExtension - a model defined in OpenAPI
