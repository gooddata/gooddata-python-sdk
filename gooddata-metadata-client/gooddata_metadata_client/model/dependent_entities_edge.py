...
class DependentEntitiesEdge(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            '_from': (EntityIdentifier,),  # noqa: E501
            'to': (EntityIdentifier,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, _from, to, *args, **kwargs):  # noqa: E501
        """DependentEntitiesEdge - a model defined in OpenAPI

        Args:
            _from (EntityIdentifier):
            to (EntityIdentifier):
