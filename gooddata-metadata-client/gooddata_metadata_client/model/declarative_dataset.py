...
class DeclarativeDataset(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, title, grain, attributes, facts, references, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            attributes ([DeclarativeAttribute]): An array of attributes.
            facts ([DeclarativeFact]): An array of facts.
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, title, grain, attributes, facts, references, *args, **kwargs):  # noqa: E501
        """DeclarativeDataset - a model defined in OpenAPI
