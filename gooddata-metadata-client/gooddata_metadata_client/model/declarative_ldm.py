...
class DeclarativeLdm(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, datasets, date_instances, *args, **kwargs):  # noqa: E501
        """DeclarativeLdm - a model defined in OpenAPI

        Args:
            datasets ([DeclarativeDataset]): An array containing datasets.
            date_instances ([DeclarativeDateDataset]): An array containing date-related datasets.
        ...
        self.date_instances = date_instances
    ...
    @convert_js_args_to_python_args
    def __init__(self, datasets, date_instances, *args, **kwargs):  # noqa: E501
        """DeclarativeLdm - a model defined in OpenAPI
