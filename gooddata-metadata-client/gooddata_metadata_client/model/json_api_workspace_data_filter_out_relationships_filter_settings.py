...
class JsonApiWorkspaceDataFilterOutRelationshipsFilterSettings(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiWorkspaceDataFilterOutRelationshipsFilterSettings - a model defined in OpenAPI
