...
class DataSourceActionsControllerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.generate_logical_model = _Endpoint(
            settings={
            ...
            callable=__generate_logical_model
        )

        def __register_upload_notification(
            self,
            data_source_id,
            **kwargs
        ):
        ...
        self.register_upload_notification = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
            ...
            api_client=api_client,
            callable=__register_upload_notification
        )
