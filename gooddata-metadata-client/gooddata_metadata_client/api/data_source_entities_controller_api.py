...
class DataSourceEntitiesControllerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_all_entities_data_source_tables(
            self,
            data_source_id,
            **kwargs
        ):
        ...
        self.get_all_entities_data_source_tables = _Endpoint(
            settings={
            ...
            callable=__get_all_entities_data_source_tables
        )

        def __get_entity_data_source_tables(
            self,
            data_source_id,
            id,
            **kwargs
        ...
        self.get_entity_data_source_tables = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_entity_data_source_tables
        )
