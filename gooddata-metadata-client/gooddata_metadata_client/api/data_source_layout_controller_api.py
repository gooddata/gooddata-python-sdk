...
class DataSourceLayoutControllerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_pdm_layout = _Endpoint(
            ...
            callable=__get_pdm_layout
        )

        def __set_pdm_layout(
            self,
            data_source_id,
            declarative_pdm,
            **kwargs
