...
class LayoutApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_workspace_permissions1_endpoint = _Endpoint(
            settings={
    ...
    def get_workspace_permissions(
        ...
        **kwargs
        ...
        >>> thread = api.get_workspace_permissions(workspace_id, declarative_workspace_permissions, async_req=True)
        >>> result = thread.get()
    ...
    def get_workspace_permissions1(
        self,
        workspace_id,
        **kwargs
    ):
        ...
        >>> thread = api.get_workspace_permissions1(workspace_id, async_req=True)
        >>> result = thread.get()
