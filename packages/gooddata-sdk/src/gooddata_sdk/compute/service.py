...
class ComputeService:
    ...
    def ai_chat(
        ...
        Args:
            ...
            allowed_relationship_types (Optional[list[AllowedRelationshipType]]): optional list of relationship types
                to restrict which metadata object relationships appear in GenAI chat search results. Defaults to None.
        Returns:
