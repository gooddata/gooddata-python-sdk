...
def test_with_data_source_messages_empty_original(sample_schema, sample_data_source_message):
    augmented_schema = with_data_source_messages(sample_schema, [sample_data_source_message])
...
def test_with_data_source_messages_non_empty_original(sample_schema, sample_data_source_message):
    ...
    augmented_schema = with_data_source_messages(sample_schema_with_some_metadata, [sample_data_source_message])
